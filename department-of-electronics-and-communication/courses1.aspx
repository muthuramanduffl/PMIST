<%@ Page Language="C#" AutoEventWireup="true" CodeFile="courses1.aspx.cs" Inherits="courses1" %>
            ...
            <div class="swiper-container menuSwiper py-3">
                <div class="placementBorderBottom swiper-wrapper ">
                    <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2 ">
                        <a href="default.aspx" class="blackColor textdecorationNone   pb-1  d-block  ">Home
                        </a>
                    </div>
                    <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2 ">
                        <a href="about.aspx" class="blackColor textdecorationNone   pb-1  d-block  ">About
                        </a>
                    </div>
                    <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2 activeBorderBottom">
                        <a href="courses.aspx" class="blackColor textdecorationNone   pb-1  d-block ">Programs
                        </a>
                    </div>

                    <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                        <a href="faculty.aspx" class="blackColor textdecorationNone   pb-1  d-block ">Faculty
                        </a>
                    </div>


                    <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                        <a href="infrastructure.aspx" class="blackColor textdecorationNone   pb-1  d-block ">Infrastructure
                        </a>
                    </div>
                    <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                        <a href="activities.aspx" class="blackColor textdecorationNone   pb-1  d-block ">Activities
                        </a>
                    </div>
                    <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                        <a href="events.aspx" class="blackColor textdecorationNone   pb-1  d-block ">Events
                        </a>
                    </div>
                    <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                        <a href="gallery.aspx" class="blackColor textdecorationNone   pb-1  d-block ">Gallery
                        </a>
                    </div>
                    <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                        <a href="placement.aspx" class="blackColor textdecorationNone   pb-1  d-block ">Placement
                        </a>
                    </div>
                    <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                        <a href="accolades.aspx"
                            class="blackColor textdecorationNone   pb-1  d-block ">Accolades
                        </a>
                    </div>

                    <div class="px-3 py-1  pb-2 placementBorder swiper-slide widthAuto">
                        <a href="research.aspx"
                            class="blackColor textdecorationNone   pb-1  d-block ">Research
                        </a>
                    </div>

                    <div class="px-3 py-1  pb-2 placementBorder swiper-slide widthAuto">
                        <a target="_blank" href="https://www.pmu.edu/placement/collabrations.aspx" class="blackColor textdecorationNone   pb-1  d-block ">MoU / Collaborations
                        </a>
                    </div>
                    <div class="px-3 py-1  pb-2 placementBorder swiper-slide widthAuto">
                        <a href="alumni-corner.aspx" class="blackColor textdecorationNone   pb-1  d-block ">Alumni Corner
                        </a>
                    </div>
                    <div class="px-3 py-1  pb-2 placementBorder  swiper-slide widthAuto">
                        <a href="#" class="blackColor textdecorationNone   pb-1  d-block ">FAQs
                        </a>
                    </div>
                    <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                        <a href="courses.aspx" class="blackColor textdecorationNone   pb-1  d-block ">Nanotechnology
                        </a>
                    </div>
                        ...
                        <div class="profileSection pt-4 libraryBorder">
                            ...
                            <div class="mt-4">
                                <ul class="customli">
                                    <div class="mt-4">
                                        <ul class="customli">
                                            <asp:Repeater ID="rprProgramsOffered" runat="server">
                                                <ItemTemplate>
                                                    <li class='<%# Container.ItemIndex == 0 ? "" : "pt-3" %>'>
                                                        <%# Eval("Content") %>
                                                    </li>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                ...
                                <div class="panel" style="">
                                    <div class="pt-3">
                                        ...
                                        <div>
                                            ...
                                            <h5 class="blueColor   upperCase pr-3">PROGRAMME EDUCATIONAL OBJECTIVES</h5>
                                            <div class="pt-2">
                                                <asp:Label ID="lblPEoIntro" runat="server" Text=""></asp:Label>
                                                <%-- <p><%# Eval("Introduction") %></p>--%>
                                            </div>
                                            <asp:Repeater ID="rprPEO" runat="server">
                                                <HeaderTemplate>

                                                    <ul class="customli pt-4">
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <li class='<%# Container.ItemIndex == 0 ? "" : "pt-2 lh-1-8" %>'>
                                                        <%# Eval("Content") %>
                                                    </li>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                        ...
                                        <div class="pt-3">
                                            ...
                                            <h5 class="blueColor   upperCase pr-3">PROGRAM OUTCOMES
                                            </h5>
                                            <div class="pt-2">
                                                <asp:Label ID="lblpoIntro" runat="server" Text=""></asp:Label>
                                            </div>

                                            <asp:Repeater ID="rprPO" runat="server">
                                                <HeaderTemplate>
                                        ...
                                        <div class="pt-3">
                                            ...
                                            <h5 class="blueColor   upperCase pr-3">PROGRAM SPECIFIC OUTCOME
                                            </h5>
                                            <div class="pt-2">
                                                <asp:Label ID="lblPSOIntro" runat="server" Text=""></asp:Label>
                                            </div>
                                            <asp:Repeater ID="rprPSO" runat="server">
                                                <HeaderTemplate>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="panel pb-4" style="">
                                    <div class="pt-3">
                                        <div>
                                            <asp:Repeater ID="rprCurriculum" runat="server">
                                                <ItemTemplate>
                                                    <p class='<%# Container.ItemIndex == 0 ? "" : "pt-2 " %>'>
                                                        <%# Eval("Content") %>
                                                    </p>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                    ...
                                    <div class="mt-3">
                                        <div class=" pt-2 align-items-center">
                                            <asp:Repeater ID="rprPDF" OnItemCommand="rprPDF_ItemCommand" runat="server">
                                                <ItemTemplate>
                        ...
                        <div>
                            <div class="px-2 py-2 sideMenuDept sideMenu sideMenuArch">
                                <div class="p-3 sideMenuBottomBorder">
                                    <a href="default.aspx" class="textdecorationNone sideMenuHover  d-flex ">Home</a>
                                </div>
                                <div class="p-3 sideMenuBottomBorder">
                                    <a href="about.aspx" class="textdecorationNone sideMenuHover  d-flex ">About</a>
                                </div>
                                <div class="p-3 pt-4 sideMenuBottomBorder">
                                    <a class="textdecorationNone activeSideMenu sideMenuHover d-flex ">Programs</a>
                                </div>
                                <div class="p-3 pt-4 sideMenuBottomBorder">
                                    <a href="nanotechnology.aspx" class="textdecorationNone  sideMenuHover d-flex">Nanotechnology Division</a>
                                </div>
                                <div class="p-3 pt-4 sideMenuBottomBorder">
                                    <a href="faculty.aspx" class="textdecorationNone  sideMenuHover d-flex ">Faculty</a>
                                </div>
                                <div class="p-3 pt-4 sideMenuBottomBorder">
                                    <a href="infrastructure.aspx" class="textdecorationNone  sideMenuHover d-flex ">Infrastructure</a>
                                </div>
                                <div class="p-3 pt-4 sideMenuBottomBorder">
                                    <a href="activities.aspx" class="textdecorationNone sideMenuHover d-flex ">Activities</a>
                                </div>
                                <div class="p-3 pt-4 sideMenuBottomBorder">
                                    <a href="events.aspx" class="textdecorationNone sideMenuHover d-flex ">Events</a>
                                </div>
                                <div class="p-3 pt-4 sideMenuBottomBorder">
                                    <a href="gallery.aspx" class="textdecorationNone sideMenuHover d-flex ">Gallery</a>
                                </div>
                                <div class="p-3 pt-4 sideMenuBottomBorder">
                                    <a href="placement.aspx" class="textdecorationNone sideMenuHover d-flex ">Placements</a>
                                </div>
                                <div class="p-3 pt-4 sideMenuBottomBorder">
                                    <a href="accolades.aspx" class="textdecorationNone  sideMenuHover d-flex ">Accolades
                                    </a>
                                </div>
                                <div class="p-3 pt-4 sideMenuBottomBorder">
                                    <a href="research.aspx" class="textdecorationNone  sideMenuHover d-flex ">Research</a>
                                </div>
                                <div class="p-3 pt-4 sideMenuBottomBorder">
                                    <a target="_blank" href="https://www.pmu.edu/placement/collabrations.aspx" class="textdecorationNone sideMenuHover d-flex ">MoU / Colloborations</a>
                                </div>
                                <div class="p-3 pt-4 sideMenuBottomBorder">
                                    <a href="alumni-corner.aspx" class="textdecorationNone sideMenuHover d-flex ">Alumni Corner</a>
                                </div>
                                <div class="p-3 pt-4 sideMenuBottomBorder">
                                    <a href="#" class="textdecorationNone  sideMenuHover d-flex ">FAQs</a>
                                </div>
