...
public class naaccriteriaiqac
{
    ...
    public int AddCriteria(List<naaccriteriaiqac> LstNaaccriteria)
    {
        string connetionString = null;
        SqlConnection cnn;
        ...
        try
        {
            ...
            {
                foreach (naaccriteriaiqac criteria in LstNaaccriteria)
                {
                    using (SqlCommand command = new SqlCommand("AddCriteriaIQAC", cnn))
                    {
    ...
    public int UpdateCriteria(string Title, int CriteriaNo, string UpdatedBy,bool Active, DateTime dtUpdateTime,int Sno)
    {
        ...
        //{
            ...
            using (SqlCommand command = new SqlCommand("UpdateCriteriaIQAC", cnn))
            {
    ...
    public int UpdateCriteriaStatus(int ID, string updatedBy, DateTime dtUpdatedDateTime)
    {
        ...
        //try
        //{
            using (SqlCommand command = new SqlCommand("UpdateCriteriaStatusIQAC", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(
    ...
    public int DeleteCriteriaByID(int ID)
    {
        ...
        try
        {
            if (ID > 0)
            {
                ...
                cnn.Open();
                using (SqlCommand command = new SqlCommand("DeleteCriteriaIQAC", cnn))
                {
    ...
    public DataSet ViewCriteriaByNo(int CriteriaNo)
    {
        ...
        try
        {
                ...
                using (SqlCommand command = new SqlCommand("ViewCriteriaByNoIQAC", cnn))
                {
                    cnn.Open();
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(
    ...
    public DataSet ViewCriteriaById(int ID)
    {
        ...
        try
        {
            if (ID>0)
            {
                ...
                using (SqlCommand command = new SqlCommand("ViewCriteriaByIdIQAC", cnn))
                {
                    cnn.Open();
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(
    ...
    public DataSet ViewActiveCriteria()
    {
        ...
        try
        {
                ...
                using (SqlCommand command = new SqlCommand("ViewActiveCriteriaIQAC", cnn))
                {
                    cnn.Open();
                    command.CommandType = CommandType.StoredProcedure;
                     SqlDataAdapter da = new SqlDataAdapter(command);
    ...
    public DataSet ViewActiveCriteria2023()
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
        ...
        try
        {
                ...
                using (SqlCommand command = new SqlCommand("ViewActiveCriteriaIQAC2023", cnn))
                {
                    cnn.Open();
                    command.CommandType = CommandType.StoredProcedure;
                     SqlDataAdapter da = new SqlDataAdapter(command);
    ...
    public DataSet ViewAllCriteria()
    {
        ...
        try
        {
            ...
            using (SqlCommand command = new SqlCommand("ViewAllCriteriaIQAC", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
                SqlDataAdapter da = new SqlDataAdapter(command);
