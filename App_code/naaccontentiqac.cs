...
public class naaccontentiqac
{
    ...
    public int AddNaac(List<naaccontentiqac> LstNaaccriteria)
    {
        string connetionString = null;
        SqlConnection cnn;
        ...
        try
        {
            ...
            {
                foreach (naaccontentiqac naac in LstNaaccriteria)
                {
                    using (SqlCommand command = new SqlCommand("AddNaacIQAC", cnn))
                    {
    ...
    public int UpdateNaac(List<naaccontentiqac> LstNaaccriteria,int Id)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
        ...
        try
        {
            if (LstNaaccriteria != null && LstNaaccriteria.Count > 0)
            {
                foreach (naaccontentiqac naac in LstNaaccriteria)
                {
                    using (SqlCommand command = new SqlCommand("UpdateNaacIQAC", cnn))
                    {
    ...
    public int UpdateNaacStatus(int ID, string updatedBy, DateTime dtUpdatedDateTime)
    {
        ...
        //try
        //{
            using (SqlCommand command = new SqlCommand("UpdateNaacStatusIQAC", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(
    ...
    public int DeleteNaac(int ID)
    {
        ...
        try
        {
            if (ID > 0)
            {
                ...
                cnn.Open();
                using (SqlCommand command = new SqlCommand("DeleteNaacIQAC", cnn))
                {
    ...
    public DataSet ViewNaacById(int ID)
    {
        ...
        try
        {
            if (ID > 0)
            {
                ...
                using (SqlCommand command = new SqlCommand("ViewNaacByIdIQAC", cnn))
                {
                    cnn.Open();
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(
    ...
    public DataSet ViewAllNaac()
    {
        ...
        try
        {
            ...
            using (SqlCommand command = new SqlCommand("ViewAllNaacIQAC", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
                SqlDataAdapter da = new SqlDataAdapter(command);
    ...
    public DataSet ViewNaac(int CriteriaId, int MetricId,int SubMetricId)
    {
        ...
        //{
                ...
                using (SqlCommand command = new SqlCommand("ViewNaacIQAC", cnn))
                {
                    cnn.Open();
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(
    ...
    public DataSet ViewActiveNaac(int CriteriaId, int MetricId, int SubMetricId)
    {
        ...
        try
        {
            ...
            using (SqlCommand command = new SqlCommand("ViewActiveNaacIQAC", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(
    ...
    public DataSet ViewActiveNaac2023(int CriteriaId, int MetricId, int SubMetricId)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
        ...
        try
        {
            ...
            using (SqlCommand command = new SqlCommand("ViewActiveNaacIQAC2023", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(
    ...
    public DataSet ViewMaxNaac(int CriteriaId, int MetricId, int SubMetricId)
    {
        ...
        {
            cnn.Open();
            using (SqlCommand command = new SqlCommand("ViewMaxNaacIQAC", cnn))
            {
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(
                                    new SqlParameter("@CriteriaId", CriteriaId));
    ...
    public DataSet GetNaacDisplayOrderWay1(int fromDisplayOrder, int toDisplayOrder, int CriteriaId, int MetricId, int SubMetricId)
    {
        ...
        {
            cnn.Open();
            using (SqlCommand command = new SqlCommand("GetNaacDisplayOrderWay1IQAC", cnn))
            {
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(
    ...
    public DataSet GetNaacDisplayOrderWay2(int fromDisplayOrder, int toDisplayOrder, int CriteriaId, int MetricId, int SubMetricId)
    {
        ...
        {
            cnn.Open();
            using (SqlCommand command = new SqlCommand("GetNaacDisplayOrderWay2IQAC", cnn))
            {
                command.CommandType = CommandType.StoredProcedure;
    ...
    public int UpdateNaacDisplayOrder(int Sno, int DisplayOrder, string UpdatedBy)
    {
        ...
        try
        {
            using (SqlCommand command = new SqlCommand("UpdateNaacDisplayOrderIQAC", cnn))
            {
    ...
    public DataSet IsNaacDisplayOrderExists(int displayOrder, int CriteriaId, int MetricId, int SubMetricId)
    {
        ...
        {
            cnn.Open();
            using (SqlCommand command = new SqlCommand("IsNaacDisplayOrderExistsIQAC", cnn))
            {
                command.CommandType = CommandType.StoredProcedure;
    ...
    public DataSet GetNaacDisplayOrderForInsert(int fromDisplayOrder, int toDisplayOrder, int CriteriaId, int MetricId, int SubMetricId)
    {
        ...
        {
            cnn.Open();
            using (SqlCommand command = new SqlCommand("GetNaacDisplayOrderForInsertIQAC", cnn))
            {
                command.CommandType = CommandType.StoredProcedure;
    ...
    public DataSet GetNaacDisplayOrderForDelete(int fromDisplayOrder, int toDisplayOrder, int CriteriaId, int MetricId, int SubMetricId)
    {
        ...
        {
            cnn.Open();
            using (SqlCommand command = new SqlCommand("GetNaacDisplayOrderForDeleteIQAC", cnn))
            {
                command.CommandType = CommandType.StoredProcedure;
