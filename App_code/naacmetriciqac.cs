...
public class naacmetriciqac
{
    ...
    public int AddMetric(List<naacmetriciqac> LstNaaccriteria)
    {
        string connetionString = null;
        SqlConnection cnn;
        ...
        try
        {
            ...
            {
                foreach (naacmetriciqac metric in LstNaaccriteria)
                {
                    using (SqlCommand command = new SqlCommand("AddMetricIQAC", cnn))
                    {
    ...
    public int UpdateCriteria(string Title, string stMetricNo, int CriteriaNo, string UpdatedBy,bool Active, DateTime dtUpdateTime,int Sno)
    {
        ...
        //{
            ...
            using (SqlCommand command = new SqlCommand("UpdateMetricIQAC", cnn))
            {
    ...
    public int UpdateMetricStatus(int ID, string updatedBy, DateTime dtUpdatedDateTime)
    {
        ...
        //try
        //{
            using (SqlCommand command = new SqlCommand("UpdateMetricStatusIQAC", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(
    ...
    public int DeleteMetricByID(int ID)
    {
        ...
        try
        {
            if (ID > 0)
            {
                ...
                cnn.Open();
                using (SqlCommand command = new SqlCommand("DeleteMetricIQAC", cnn))
                {
    ...
    public DataSet ViewMetricById(int ID)
    {
        ...
        try
        {
            if (ID > 0)
            {
                ...
                using (SqlCommand command = new SqlCommand("ViewMetricByIdIQAC", cnn))
                {
                    cnn.Open();
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(
    ...
    public DataSet ViewAllMetric()
    {
        ...
        try
        {
            ...
            using (SqlCommand command = new SqlCommand("ViewAllMetricIQAC", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
                SqlDataAdapter da = new SqlDataAdapter(command);
    ...
    public DataSet ViewMetricByCriteria(int CriteriaNo)
    {
        ...
        try
        {
                ...
                using (SqlCommand command = new SqlCommand("ViewMetricByCriteriaIQAC", cnn))
                {
                    cnn.Open();
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(
    ...
    public DataSet ViewMetricByMetricNo(int CriteriaNo,string stMetricNo)
    {
        ...
        try
        {
            ...
            using (SqlCommand command = new SqlCommand("ViewMetricByMetricNoIQAC", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(
    ...
    public DataSet ViewActiveMetric(int CriteriaId)
    {
        ...
        //{
                ...
                using (SqlCommand command = new SqlCommand("ViewActiveMetricIQAC", cnn))
                {
                    cnn.Open();
                    command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(
    ...
    public DataSet ViewActiveMetric2023(int CriteriaId)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
        ...
        //{
                ...
                using (SqlCommand command = new SqlCommand("ViewActiveMetricIQAC2023", cnn))
                {
                    cnn.Open();
                    command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(
