...
/// </summary>
public class naacsubmetriciqac
{
    ...
    public int AddSubMetric(List<naacsubmetriciqac> LstNaaccriteria)
    {
        string connetionString = null;
        SqlConnection cnn;
        ...
        try
        {
            ...
            {
                foreach (naacsubmetriciqac metric in LstNaaccriteria)
                {
                    using (SqlCommand command = new SqlCommand("AddSubMetricIQAC", cnn))
                    {
    ...
    public int UpdateSubMetric(string Title, string stMetricNo, int CriteriaNo, int MetricId, string UpdatedBy,bool Active, DateTime dtUpdateTime,int Sno)
    {
        ...
        //{
            ...
            using (SqlCommand command = new SqlCommand("UpdateSubMetricIQAC", cnn))
            {
    ...
    public int UpdateSubMetricStatus(int ID, string updatedBy, DateTime dtUpdatedDateTime)
    {
        ...
        //try
        //{
            using (SqlCommand command = new SqlCommand("UpdateSubMetricStatusIQAC", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(
    ...
    public int DeleteMetricByID(int ID)
    {
        ...
        try
        {
            if (ID > 0)
            {
                ...
                cnn.Open();
                using (SqlCommand command = new SqlCommand("DeleteSubMetricIQAC", cnn))
                {
    ...
    public DataSet ViewSubMetricById(int ID)
    {
        ...
        try
        {
            if (ID > 0)
            {
                ...
                using (SqlCommand command = new SqlCommand("ViewSubMetricByIdIQAC", cnn))
                {
                    cnn.Open();
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(
    ...
    public DataSet ViewAllSubMetric()
    {
        ...
        try
        {
            ...
            using (SqlCommand command = new SqlCommand("ViewAllSubMetricIQAC", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
                SqlDataAdapter da = new SqlDataAdapter(command);
    ...
    public DataSet ViewSubMetricBySubMetricNo(int CriteriaNo, int MetricId, string stSubMetricNo)
    {
        ...
        //{
            ...
            using (SqlCommand command = new SqlCommand("ViewSubMetricBySubMetricNoIQAC", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(
    ...
    public DataSet ViewSubMetricByMetric(int CriteriaId, int MetricId)
    {
        ...
        //{
                ...
                using (SqlCommand command = new SqlCommand("ViewSubMetricByMetricIQAC", cnn))
                {
                    cnn.Open();
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(
    ...
    public DataSet ViewActiveSubMetric2023(int CriteriaId, int MetricId)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
        ...
        try
        {
            ...
            using (SqlCommand command = new SqlCommand("ViewSubMetricByMetricIQAC2023", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add(
