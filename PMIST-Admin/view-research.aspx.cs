...
public partial class viewresearch : System.Web.UI.Page
{ 
    ...
    public DataTable Get()
    {
        ...
        try
        {
            dt = PMP.ViewAllPlacements(ddldepartment.SelectedValue, ddlstatus.SelectedValue, "", "Research");
        }
        catch (Exception ex)
        {
        }
    ...
    protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "Delete")
        {
            ...
            { 
                int ID = Convert.ToInt32(e.CommandArgument);
                ret = PMP.DeletePMISTPlacementsByID(ID);
                if (ret == 1)
                {
                    ...
                    "alert",
                    "Swal.fire({" +
                    "  title: 'Research details has been deleted', " +
                ...
                else
                {
                    ...
                    "alert",
                    "Swal.fire({" +
                    "  title: 'Research details has been not deleted. please try again', " +
                    "  confirmButtonText: 'OK', " + // Add the missing comma here
                    "  customClass: {" +
                    "    confirmButton: 'handle-btn-success'" +
                    "  }" +
