<%@ Page Title="" Language="C#" MasterPageFile="~/PMIST-Admin/Admin.master" AutoEventWireup="true"
    CodeFile="view-infrastructure.aspx.cs" Inherits="PMIST_Admin_view_infrastructure" %>
            ...
            <div class="panel-header bg-primary-gradient">
                <div class="page-inner py-5">
                    <div
                        ...
                        <div class="d-flex">
                            <h2 class="text-white mb-0 fw-bold text-uppercase">View Infrastructure</h2>
                                            ...
                                            <asp:Repeater ID="rpruser" OnItemDataBound="OnItemDataBound"
                                                    ...
                                                    <table class="table table-bordered" id="tblUsers" role="grid"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="min-w-220">Display Status</th>
                                                ...
                                                <ItemTemplate>
                                                    <tr data-index="<%# Container.ItemIndex + 1 %>">
                                                        <asp:HiddenField ID="HiddenField1" Value='<%# Eval("INFID") %>'
                                                            runat="server" />
                                                        ...
                                                        <td>
                                                            <div class="">
                                                                <%# Convert.ToInt32(Eval("INFRStatus"))==1
                                                        ...
                                                        <td>
                                                            <asp:LinkButton class="edit-img me-3" ID="lkedit"
                                                                ...
                                                                CommandArgument='<%# DataBinder.Eval(Container.DataItem, "INFID") %>'>
