...
{ 
    ...
    pmistinfrastruncture PMINFra = new pmistinfrastruncture();
    ...
    public DataTable Get()
    {
        ...
        try
        {
            dt = PMINFra.ViewAllInfrastructure(ddldepartment.SelectedValue, ddlstatus.SelectedValue, "");
        }
        catch (Exception ex)
        {
        }
    ...
    protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "Edit")
        {
            try
            {
                ...
                Response.Redirect("add-infrastructure.aspx?INFID=" + ID, false);
        ...
        else if (e.CommandName == "Delete")
        {
            ...
            try
            {
                ...
                int ID = Convert.ToInt32(e.CommandArgument);
                ret = PMINFra.DeletePMISTInfrastructureByINFID(ID);
                if (ret == 1)
                {
                    ...
                    "alert",
                    "Swal.fire({" +
                    "  title: 'Infrastructure has been deleted', " +
                ...
                else
                {
                    ...
                    "alert",
                    "Swal.fire({" +
                    "  title: 'Infrastructure has been not deleted. please try again', " +
                    "  confirmButtonText: 'OK', " + // Add the missing comma here
                    "  customClass: {" +
                    "    confirmButton: 'handle-btn-success'" +
                    "  }" +
