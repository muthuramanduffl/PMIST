<%@ Page Title="" Language="C#" MasterPageFile="~/PMIST-Admin/Admin.master" AutoEventWireup="true" CodeFile="view-resource-for-researchers.aspx.cs" Inherits="PMIST_Admin_view_placements" %>
        ...
        <div class="panel-header bg-primary-gradient">
            <div class="page-inner py-5">
                <div class="d-flex pb-2 align-items-left align-items-md-center flex-column flex-md-row justify-content-between">
                    <div class="d-flex">
                        <h2 class="text-white mb-0 fw-bold text-uppercase">Resource-for-Researchers</h2>
                                    ...
                                    <div class="col-md-3 pt-3">
                                        <div class="input-icon input-icon-sm right">
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlresearch" class="bs-select form-control input-sm" AutoPostBack="true" OnSelectedIndexChanged="ddldepartment_SelectedIndexChanged" runat="server">
                                                        <asp:ListItem Selected="True" Value=""></asp:ListItem>
                                                    </asp:DropDownList>
                                                </ContentTemplate>
                                                <Triggers>
                                                    <asp:AsyncPostBackTrigger ControlID="ddlresearch" EventName="SelectedIndexChanged" />
                                ...
                                <asp:UpdatePanel ID="UpdatePanel5" UpdateMode="Conditional" runat="server">
                                    <ContentTemplate>
                                        <asp:Repeater ID="rpruser" OnItemCommand="Repeater1_ItemCommand" OnItemDataBound="OnItemDataBound" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <asp:HiddenField ID="HiddenField1" Value='<%# Eval("RFID") %>' runat="server" />
                                                    ...
                                                    <td>
                                                        <div class="">
                                                            <%# Convert.ToInt32(Eval("CStatus")) == 1 ? 
                                                    ...
                                                    <td>
                                                        <asp:LinkButton class="edit-img me-3" ID="lkedit" runat="server" CommandName="Edit"
                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem, "RFID") %>'>
                                                       <i class="bi bi-pencil-square b5-icon-et-dlt" data-bs-toggle="tooltip" aria-label="Edit" data-bs-original-title="Edit"></i>
                                                        ...
                                                        <asp:LinkButton ID="LinkButton2" CausesValidation="false" runat="server" class="dlt-img hidden" Text="Delete" CommandName="Delete" CommandArgument='<%# Eval("RFID") %>' Style="display: none">
                                                        </asp:LinkButton>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
