...
public partial class PMIST_Admin_placements : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["PID"] != null)
        {
            if (int.TryParse(Request.QueryString["PID"], out value))
            {
                //edit
                btnSave.Text = "Update";
                lbldisplayText.Text = "Edit Placements";
                ...
                string script = string.Format(@" 
                    ...
                    Swal.fire({{ 
                        ...
                        customClass: {{ 
                            ...
                            window.location.href = 'view-placements.aspx';   
                    }}); 
                    </script>");
        ...
        {
            lbldisplayText.Text = "Add Placements";
            btnSave.Text = "Submit";
            //add
        }
            ...
            if (Request.QueryString["PID"] == null)
            {
                ...
                if (ret == 1)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert",
                           "Swal.fire({ " +
                           "  title: 'Placement detail has been added successfully.', " +
                           "  icon: 'success', " +
                ...
                else
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert",
       "Swal.fire({ " +
       "  title: 'Placement detail has not been added due to a server issue.', " +  // Corrected the title string
       "  icon: 'success', " +
       ...
       "});", true);
            ...
            else
            {
                ...
                if (ret == 1)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert",
                           "Swal.fire({ " +
                           "  title: 'Placement detail has been update successfully.', " +
                           "  icon: 'success', " +
                           "  allowOutsideClick: 'true', " +
                           "  customClass: { " +
                           "    icon: 'handle-icon-clr', " +
                ...
                else
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert",
                                               "Swal.fire({ " +
                                               "  title: 'Placement detail has not been updated due to a server issue., " +
                                               "  icon: 'success', " +
                                               "  allowOutsideClick: 'true', " +
                                               "  customClass: { " +
                                               "    icon: 'handle-icon-clr', " +
