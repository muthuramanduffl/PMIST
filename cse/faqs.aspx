<%@ Page Language="C#" AutoEventWireup="true" CodeFile="faqs.aspx.cs" Inherits="department_of_architecture_new_faqs" %>
    ...
    <div class="navigationSection  placementBg menuMobileBlock">
        <div class="swiper-container menuSwiper py-3">
            <div class="placementBorderBottom swiper-wrapper ">
                ...
                <div class="px-3 py-1  pb-2  swiper-slide widthAuto activeBorderBottom">
                ...
                <div class="col-lg-9 col-sm-12 col-md-12 col-xs-12 ">
                    <div class="profileSection pt-4 libraryBorder">
                        <div class="container-fluid  py-2">
                            <div class="d-flex">
                                <h3 class="blueColor pr-3 mb-0 "> FAQs</h3>
                        ...
                        <div class="container-fluid">
                            <div>
                                ...
                                <div class="pt-1  lh-1-8">
                                    <div>
                                        Computer Science is a rapidly growing field that develops the basic 
                                        knowledge and skills for today’s world. There are 2.4 million job 
                                        openings in computer science and engineering before 2025 for STEM 
                                        (Science, Technology, Engineering, and Math). So you also can be one along with them!
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="pt-1  lh-1-8">
                                    <div>
                                        Many of our undergraduate students are pursuing B.Tech. Computer Science and 
                                        Engineering in PMIST tell us that they came to the CSE department with no programming 
                                        experience. PMIST students are hardworking, and can readily become experts in writing 
                                        codes and build software under the guidance of the Industry and academic experienced faculty members.
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="pt-1  lh-1-8">
                                    <div>
                                        Career opportunities for Computer Science graduates are limitless. The rapid growth in technology-based 
                                        jobs in all industries has created a need for technologically skilled professionals. Virtually every 
                                        industry applies Computer Science professionals in a variety of ways – from computerized control of 
                                        hazardous and remote environments to payroll processing in traditional industries. Industry, government 
                                        and businesses seeking graduates in a wide variety of areas including software systems design, internet 
                                        computing and networking, regularly recruit our graduates.
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="pt-1  lh-1-8">
                                    <div>
                                        Yes.  Many undergraduate students participate in research with our faculty members for their personal growth. 
                                        The department also motivates the students to participate in other activities outside the classroom. 
                                        This includes attending conferences and publishing papers in reputed journals, Industrial visits and Internships. 
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="pt-1  lh-1-8">
                                    <div>
                                        The Department of CSE is a unique department in the university which takes parental care on the professional growth 
                                        of the students. The department follows best practices for the development of students :
                                    </div>
                                    <div class="pt-2">
                                        <ul class="customli">
                                            <li class="lh-1-8">
