                ...
                <div class="col-lg-9 col-sm-12 col-md-12 col-xs-12 ">
                    <div class="profileSection pt-4 libraryBorder">
                        ...
                        <div class="mt-4">
                            <ul class="customli">
                                <li class="">
                                    B.Tech. (Computer Science )- Regular 4 Years 
                                </li>
                                ...
                                <div class="pt-3">
                                    ...
                                    <div>
                                        ...
                                        <ul class="customli pt-4">
                                            <li class="lh-1-8">
                                                Graduates will attain the expertise of analyzing and specifying 
                                                the requirements for any computing system as well as capable of modeling, 
                                                designing,implementing and verifying a computing system to meet specified 
                                                requirements using contemporary tools.
                                            </li>
                                            <li class="pt-2 lh-1-8">
                                                Graduates will possess diversified professional skills for a successful career.
                                            </li>
                                            <li class="pt-2 lh-1-8">
                                                Graduates of the programme will have the competencies for communicating, 
                                                planning, coordinating, organizing, decision making and leading a team.
                                            </li>
                                            <li class="pt-2 lh-1-8">
                                                Graduates will be aware of ethical, social and cultural issues within a global context and their 
                                                importance in the exercise of professional skills and responsibilities.
                                            </li>
                                            <li class="pt-2 lh-1-8">
                                                Graduates of the programme will have knowledge of professional, interpersonal and ethical 
                                                responsibility and will contribute to society through active research.
                                            </li>
                                        </ul>
                                    ...
                                    <div class="pt-3">
                                        ...
                                        <ul class="customli pt-4">
                                            ...
                                            <li class="pt-2 lh-1-8">
                                                Ability to analyze a problem, interpret data, and define the computing system 
                                            ...
                                            <li class="pt-2 lh-1-8">
                                                Ability to apply creativity in the design of systems which would help to investigate the 
                                                complex problem and provide software solutions.
                                            </li>
                                            <li class="pt-2 lh-1-8">
                                                Ability to use the computing techniques, skills, and modern system tools necessary for 
                                            ...
                                            <li class="pt-2 lh-1-8">
                                                Ability to develop and use the software systems within realistic constraints environmental, health and safety, 
                                                manufacturability, and sustainability considerations.
                                            </li>
                                            <li class="pt-2 lh-1-8">
                                                Ability in understanding of professional, ethical, legal, security and social issues and responsibilities.
                                            </li>
                                            <li class="pt-2 lh-1-8">
                                                Ability to function effectively on teams and individually to accomplish a common goal.
                                            </li>
                                            <li class="pt-2 lh-1-8">
                                                Ability to communicate effectively with a range of audiences orally and through writing.
                                            </li>
                                            <li class="pt-2 lh-1-8">
                                                Ability to plan, organize and follow best practices and standards so that the project is completed successfully 
                                                by meeting performance, quality at CMM level, budget and time.
                                            </li>
                                            <li class="pt-2 lh-1-8">
                                                Ability to engage in Lifelong learning and continuing professional development.
                                            </li>
                                        </ul>
                                    ...
                                    <div class="pt-3">
                                        ...
                                        <ul class="customli pt-4">
                                            <li class="lh-1-8">
                                                Ability to employ latest computer languages, environments and platforms for 
                                                solving problems in the areas of emerging communication technologies.
                                            </li>
                                            <li class="pt-2 lh-1-8">
                                                Ability to use knowledge in data analytics and mining for industrial problems.
                                            </li>
