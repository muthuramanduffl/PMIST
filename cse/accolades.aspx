<%@ Page Language="C#" AutoEventWireup="true" CodeFile="accolades.aspx.cs"
    Inherits="department_of_architecture_new_accolades" %>
    <%@ Register Src="~/includes/UCDepartmentMenuHeader.ascx" TagPrefix="uc1" TagName="Header" %>
        <%@ Register Src="~/includes/UCDepartmentMenuFooter.ascx" TagPrefix="uc2" TagName="Footer" %>
            <%@ Register Src="~/includes/socialmedia-share-floated.ascx" TagPrefix="uc3"
                TagName="socialmediasharefloated" %>
                <%@ Register src="~/includes/UCAdmission.ascx" tagname="admission" tagprefix="uc" %>
                    <%@ Register src="includes/UCHomeBanner.ascx" tagname="Banner" tagprefix="uc4" %>
                        ...
                        <head runat="server">
                            ...
                            <meta name="description" content="" The Department imparts high quality education in the
                            ...
                            <meta property="og:description" content="" The Department imparts high quality education in
                            ...
                            <meta property="twitter:title"
                                content="Department of Computer Science & Engineering | PMIST">
                            <meta property="twitter:description" content="" The Department imparts high quality
                                education in the field of Computer Science and Engineering."">
                    ...
                    <a href="gallery.aspx" class="blackColor textdecorationNone pb-1  d-block ">
                        Gallery
                                            ...
                                            <div
                                                class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2 activeBorderBottom">
                                            ...
                                            <div class="px-3 py-1  pb-2 placementBorder swiper-slide widthAuto">
                                                <a href="research.aspx"
                                                    class="blackColor textdecorastionNone Owald OswaldR pb-1  d-block ">
                                                    Research
                                                </a>
                                            </div>
                                            ...
                                            <div class="px-3 py-1  pb-2 placementBorder swiper-slide widthAuto">
                                                <a target="_blank"
                                                    href="https://www.pmu.edu/placement/collabrations.aspx"
                                                    class="blackColor textdecorationNone pb-1  d-block ">
                                                    MoU / Collaborations
                                                </a>
                                            </div>
                                            <div class="px-3 py-1  pb-2 placementBorder swiper-slide widthAuto">
                                                <a href="alumni-corner.aspx"
                                                    class="blackColor textdecorationNone pb-1  d-block ">
                                                    Alumni Corner
                                                </a>
                                            </div>
                                            ...
                                            <div class="col-lg-9 col-sm-9 col-md-9 col-xs-12 ">
                                                <div class="profileSection pt-4 libraryBorder">
                                                    <div class="container-fluid  py-2">
                                                        <div class="d-flex">
                                                            <h3 class="blueColor upperCase pr-3 mb-0 "> Awards/ Honours
                                                                / Achievements</h3>
                                                    ...
                                                    <div class="container-fluid">
                                                        <div class="pt-4">
                                                            <div>
                                                                <h4 class="blueColor"> FACULTY AWARD </h4>
                                                            </div>
                                                            <!-- <div class="pt-2 fontBold">
                                    Our students actively participated in International and National events like Symposium, 
                                    Conference and brought many laurels to the department by exposing their technical and leadership skills.
                                </div> -->

                                                            <div class="pt-2">
                                                                <ul class="customli">
                                                                    <li class="lh-1-8">
                                                                        Dr.M.Sharmila Begum, Associate Professor,
                                                                        Computer Science and Engineering received
                                                                        Best Researcher Award provided by organization
                                                                        of Science &amp; Innovative Engineering
                                                                        and Technology (OSIET) organized by Shri
                                                                        Padmavathi Engineering College, Chennai
                                                                        on June 2022.
                                                                    </li>
                                                                    <li class="lh-1-8">
                                                                        Dr.A.E.Narayanan, Associate Professor received
                                                                        Chancellor Award 2023 in Annual day
                                                                        on March 2023
                                                                    </li>

                                                                    <li class="lh-1-8">
                                                                        Dr.R.Poonguzhali Associate Professor received
                                                                        “Bharat Ratna Dr.Radhakrishnan Gold
                                                                        Medal Award” for outstanding individual
                                                                        achievement in the field of education in 73 rd
                                                                        National Unity Conference Organized by Global
                                                                        Economic progress and Research
                                                                        Association, Chennai on Feb 2022
                                                                    </li>
                                                                    <li class="lh-1-8">
                                                                        Dr. P. Ilangovan Assistant Professor (SS)
                                                                        received Chancellor Award 2023 in Annual day
                                                                        on March 2022
                                                                    </li>
                                                            ...
                                                            <div>
                                                                <h4 class="blueColor"> STUDENT AWARD </h4>
                                                            </div>
                                                            ...
                                                            <div class="pt-2">
                                                                <ul class="customli">
                                                                    <li class="lh-1-8">
                                                                        Mr.S.Harshwardhan of batch 2021-25 received
                                                                        First Position in District Open
                                                                        Junior Athletic Meet 2021 - in 110 m Hurdles.
                                                                    </li>
                                                                    <li class="lh-1-8">
                                                                        Mr.A.Kathereswaran of batch 2020-24received
                                                                        Little England 2 nd
                                                                        International Fide Rating below 1600 Chess
                                                                        Tournament and scored 14 th place in merit list.
                                                                    </li>
                                                                    <li class="lh-1-8">
                                                                        Ms.Mukta Bhadouria cleared NCC ‘B’ certificate
                                                                        organized by Ministry of
                                                                        Defense,Government of India in December 2022.
                                                                    </li>

                                                                    <li class="lh-1-8">
                                                                        Ms. S.Deepika, of batch 2018-22 received SAKTHI
                                                                        AWARD on International
                                                                        Women’s day organized by JCI Thanjavur Eves
                                                                        Capital on 08.03.2022 .
                                                                    </li>
                                                                    <li class="lh-1-8">
                                                                        Mr. Mohammed Anies, Mr.S.Vignesh, of Batch
                                                                        2017-21 received BEST PAPER
                                                                        AWARD for the paper titled “Seasonal Food
                                                                        Recommendation framework using
                                                                        Machine Learning and Matching Algorithm”in the
                                                                        National Conference on Intelligent
                                                                        Computing and Automation organized by Kamaraj
                                                                        College of Engineering and
                                                                        Technology on April2021.
                                                                    </li>
                                                                    <li class="lh-1-8">
                                                                        P.Shanthini of batch 2018-22 presented and won
                                                                        III prize in paper presentation in
                                                                        National level Virtual symposium on June 2021
                                                                    </li>
                                                                    <li class="lh-1-8">
                                                                        R.Karan of batch 2019-23 won Direct Entry
                                                                        contest in Internshala Student partner on
                                                                        November 2021
                                                                    </li>
                                                                    <li class="lh-1-8">
                                                                        Ms.Kavimuhil, of batch 2017-21 participated in
                                                                        NCC CATC – RD Parade on 26 January
                                                                ...
                                                                <!-- <ul class="customli">
                                      <li class="lh-1-8">
                                        Ms.K.Ananiya, Mr.R.J.RagulSweetlin won first prize in the Poster Presentation in the National Level 
                                        Conference on Robotics, Artificial  Intelligence and Machine Learning at RVS Educational Trust Group 
                                        of Institutions, Dindigul on 11th October 2019.
                                      </li>
                                      <li class="pt-2 lh-1-8">
                                        M.VikramPandi won first prize in the paper presentation event in the National Level at M.A.M College 
                                        of Engineering and Technology, Trichy on 22ndFebruary 2019.
                                      </li>
                                      <li class="pt-2 lh-1-8">
                                        Mr.M.VikramPandi and Ms.A.S.Rasmika won first  prize in the paper presentation event in the National Level 
                                        Technical Symposium TECHNOTRON-2018 at Sri Shanmuga College of Engineering and Technology, Salem on 6th September 2018.
                                      </li>
                                      <li class="pt-2 lh-1-8">
                                        Ms.Kavimuhil, Second year CSE student participated in NCC CATC – RD Parade at Rajpath on 26th  
                                        January 2018, New Delhi.
                                                            ...
                                                            <div>
                                                                <h4 class="blueColor"> ALUMNUS ACHIEVEMENT </h4>
                                                            </div>
                                                            ...
                                                            <div class="pt-2">
                                                                <ul class="customli">
                                                                    <li class="lh-1-8">
                                                                        K.Suresh Arunachalam of batch : 2015-2019 and
                                                                        T.Devendran 2016- 2020 participated in
                                                                        Scalar Events “Chennai Hacks” on 26 th and 27 th
                                                                        March 2022- 24 Hours Coding Contest
                                                                        and won Third Prize and 70K Scholarship among
                                                                        800+ Registration.
                                                                    </li>
                                ...
                                <a href="gallery.aspx" class="textdecorationNone sideMenuHover d-flex ">
                                    Gallery</a>
                                                            ...
                                                            <div class="p-3 pt-4 sideMenuBottomBorder">
                                                                <a
                                                                    class="textdecorationNone activeSideMenu  sideMenuHover d-flex ">
                                                                    Accolades
                                                                </a>
                                                            </div>
                                                            <div class="p-3 pt-4 sideMenuBottomBorder">
                                    ...
                                    <div class="whatsappIcon">
                                        <a href="https://wa.me/919790111911" class="whatsapp whiteColor"
                        ...
                        <script type="text/javascript"
                            src="https://cdn.jsdelivr.net/npm/pushbar.js@1.0.0/src/pushbar.min.js"></script>
