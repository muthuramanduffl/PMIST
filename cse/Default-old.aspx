...
<uc3:socialmediasharefloated runat="server" ID="socialmediasharefloated" />
            ...
            <div>
                <div>
                    <div class="d-flex justify-content-center align-items-center">
                        ...
                        <h3 class="upperCase blueColor py-3 m-0  ">About </h3>
                        <div class="headingAfter mt-1 ml-3"></div>

                    </div>
                    <p class="text-justify lh-2 pt-2 text-center">
                        Began in the year 1988 with the approval of AICTE, The 
                        Computer Science and Engineering Department imparts high 
                        quality education in the field of Computer Science and Engineering 
                        and also develops the overall personality of the students. Accredited 
                        by National Board of Accreditation in 1998, the Department facilitates 
                        the students to enrich technical know-how with the guidance of a team of 
    ...
    <div class="my-5">
        <div class="row">
            <div class="col-lg-2 px-0">
                <div style="background-image: url('../images/cph-bga.png');" class="seminarBg p-4">
                    <div class="py-2">
                        <div class="">
                            <div class="text-center">
                                <h3 class="whiteColor">100%</h3>
                                <h6 class="pt-2">Placement Assistance</h6>
                            </div>
                        </div>
                        <div class="mt-5">
                            <div class="text-center">
                                <h3 class="whiteColor">100+</h3>
                                <h6 class="pt-2">Industry Tie Ups</h6>
                            </div>
                        </div>
                        <div class="mt-5">
                            <div class="text-center">
                                <h3 class="whiteColor">1500+</h3>
                                <h6 class="pt-2">Offers issued globally for last three years </h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-10 px-0">
                <div style="background-image: url('../images/cph-bg.png');" class="hodBg p-4 mt-5">
                    <div>
                        <div class="d-flex justify-content-between">
                            <div class="d-flex align-items-center">
                                <h3 class="upperCase whiteColor py-3 m-0  ">HOD Desk </h3>
                        ...
                        <div class="pt-3 whiteColor">
                            <p>
                                The Computer Science and Engineering department aims at nurturing a conducive 
                                upbringing for erudition and research by use of appropriate computing technologies 
                                in its everyday activities.  The department has been offering excellent infrastructural 
                                facilities with a variety of computing platforms to aspiring professional students to 
                                meet the burgeoning demands of the IT industry. Students are encouraged to join various 
                                technical and non-technical forums, which in turn gives them horizontal exposure to 
                                Engineering concepts and technology.
                                I congratulate and welcome the budding Computer Science Engineers to join the family of 
                                Computer Science and Engineering Department for their wish to succeed and I wish all of 
                                them a great success in their bright future…

                            </p>
                        </div>
                        <div class="d-flex justify-content-end whiteColor pr-4">
                            <div>
                                <div>
                                ...
                                <div class="pt-1">
                                    <div>
                                        <h4 class="mb-0   text-center text-uppercase">Dr. M. Sharmila Begum</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="newsSection mb-5 mt-3  container-fluid">
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                <div>
                    <div class="d-flex align-items-center">
                        <h3 class="upperCase blueColor py-3 m-0 f-20 ">PROGRAMME OVERVIEW</h3>
                        <div class="headingAfter ml-3 mt-1"></div>
                    </div>
                    <ul class="customli pl-3 pt-2">
                        <li class="pl-1 lh-2 f-15">
                            Imparts high quality education in the field of Computer Science 
                            and Engineering and also develops the overall personality of the students.
                        </li>
                        <li class="pl-1 lh-2 f-15">
                            Facilitates the students to enrich technical know-how with the 
                            guidance of a team of well qualified and dedicated faculty members. 
                        </li>
                        <li class="pl-1 lh-2 f-15">
                            Prepares the studentsto become globally competent by enhancing 
                            their skills to work in IT Industries and R & D organizations.
                        </li>
                    </ul>
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 d-flex justify-content-center 
            align-items-center newLogoAfterOneTwo positionRelative disnoneMobile">
            <div>
                <img src="./images/POIcon.jpg" class="w-100" />
            </div>
            ...
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                <div>
                    <div class="d-flex align-items-center">
                        <h3 class="upperCase blueColor py-3 m-0 f-20 ">SCOPE OF CSE </h4>
                            <div class="headingAfter ml-3 mt-1"></div>
                    </div>

                    <ul class="customli pl-3 pt-2">
                        <li class="pl-1 lh-2 f-15">
                            Intelligence and smart systems rule our daily life.
                        </li>
                        <li class="pt-3 pl-1 lh-2 f-15">
                            Industrial revolution 4.0 includes cyber – physical system, 
                            big data analytics, cloud computing and Internet of Things.
                        </li>
                        <li class="pt-3 pl-1 lh-2 f-15">
                            Great opportunities for true creativity and innovativeness in the area of infotainment.
                        </li>
                        <li class="pt-2 pl-1 lh-2 f-15">
                            Plenty of opportunities to work in MNC’s on shore and off-shore.
                        </li>
                        <li class="pt-2 pl-1 lh-2 f-15">
                            Digital age requires computer and data scientists.
                        </li>
    ...
    <div class="footerBg py-5" style="background:url('./images/CSE.jpg') ;">
        <div class="container-fluid">
            <div class="text-center">
                <h1 class="whiteColor upperCase py-5">
                    <span class="yellowColor ">High</span>Lights </span>
                </h1>
            </div>
            <div class="row container-fluid">
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 resPaddingLeft">
                    <div>
                        <h4 class="whiteColor upperCase f-20 ">Best Practices</h4> 
                        <ul class="highlightsLi f-15">
                            <li class="whiteColor lh-2O pt-2 pb-1 m-0 f-15">
                                Value added programmes with TCSiON and RedHat Certification.
                            </li>
                            <li class="whiteColor lh-2 pt-2 pb-2 m-0 f-15">
                                Code development practice in Code Hackathon platform. 
                            </li>
                            
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 resPaddingLeft campusBorder">
                    <div>
                        <h4 class="whiteColor upperCase f-20">LABORATORIES</h4>
                        <ul class="highlightsLi f-15">
                            <li class="whiteColor lh-2O pt-2 pb-1 m-0 f-15">
                                7 laboratories with 210 computer systems.
                            </li>
                            <li class="whiteColor lh-2O pt-2 pb-2 m-0 f-15">
                               Exclusive lab for project work. 
                            </li>
                            <li class="whiteColor lh-2O pt-2 pb-2 m-0 f-15">
                                Exclusive research lab for new innovations. 
                             </li>
            ...
            <div class="d-flex justify-content-center my-4 logoMargin positionRelative">
                <div>
                    <img src="../../images/new-logo1-1.png" class="logoAfterMargin" />
                </div>
            ...
            <div class="row container-fluid pt-3">
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 resPaddingLeft">
                    <div>
                         <h4 class="whiteColor upperCase f-20 ">PLACEMENT</h4> 
                        <ul class="highlightsLi f-15">
                            <li class="whiteColor lh-2O pt-2 pb-2 m-0 f-15">
                                100% Placement during three consecutive years 2016 and 17, 2018 and 2019, 80% of students 
                                got placed and others joined in higher studies. In the current year 2020 85% are placed. 
                            </li>
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 resPaddingLeft campusBorder">
                    <div>
                        ...
                        <ul class="highlightsLi f-15">
                            <li class="whiteColor lh-2O pt-2 pb-2 m-0 f-15">
                                Availability of proprietary and open source software for research promotions. 
                            </li>
                            <li class="whiteColor lh-2O pt-2 pb-2 m-0 f-15">
                                Special coaching for Placement and other Competitive exams like GATE, etc.  
                            </li>
                    </div>
                </div>
            </div>
