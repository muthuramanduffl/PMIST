<%@ Page Language="C#" AutoEventWireup="true" CodeFile="about.aspx.cs" Inherits="department_of_architecture_new_about" %>
        ...
        <div class="swiper-container menuSwiper py-3">
            <div class="placementBorderBottom swiper-wrapper ">
                ...
                <div class="px-3 py-1  pb-2 placementBorder swiper-slide widthAuto">
                    <a href="research.aspx" href="research.aspx"
                        class="blackColor textdecorationNone  pb-1  d-block ">
                        Research
                    </a>
                </div>
    ...
    <div>
        <div class="py-5">
            <div class="row  container-fluid">
                <div class="col-lg-9 col-sm-12 col-md-12 col-xs-12 archdept">
                    <div class="profileSection pt-4 libraryBorder">
                        <div>
                            <div class="container-fluid  py-2">
                                <div class="d-flex">
                                    <h3 class="blueColor  upperCase pr-3 mb-0 "> About</h3>
                                    <div class="headingAfter"></div>
                                </div>
                            </div>
                            <div class="newsSection mt-3  container-fluid">
                                <div>
                                    <div>
                                            <p class="text-justify lh-2 pt-2">
                                                Began in the year 1988 with the approval of AICTE, The Computer Science 
                                                and Engineering Department imparts high quality education in the field of 
                                                Computer Science and Engineering and also develops the overall personality 
                                                of the students. Accredited by National Board of Accreditation in 1998, the 
                                                Department facilitates the students to enrich technical know-how with the 
                            ...
                            <div class="mt-5">
                                ...
                                <div class="panel" style="">
                                   <div classs="pt-3">
                                    To be a leader in imparting advanced technical knowledge and skills in the field of Computer Science and Engineering with societal consciousness.
                                ...
                                <div class="panel" style="">
                                   <div classs="pt-3">
                                    <ul class="customli pl-3 pt-2">
                                        <li class="pl-1 lh-1-8">
                                            To offer programmes with state of art facilities in the field of Computer Science and Engineering
                                        </li>
                                        <li class="pt-3 pl-1 lh-1-8">
                                           	To prepare the students to become globally competent by enhancing their skills to work in IT Industries and R & D organizations
                                        </li>
                                        <li class="pt-3 pl-1 lh-1-8">
                                            To prepare the students to have universal values and an ability to relate engineering issues with environmental consciousness to broader social context.
                                        </li>
                                        <li class="pt-3 pl-1 lh-1-8">
                                            To promote significant research in cutting edge Computing technologies.
                            ...
                            <!--<div class="mt-3">
                                ...
                                <div class="panel" style="">
                                   <div classs="pt-3">
                                    The objectives of the department is to produce successful professionals
                                    who can
                                    understand societal and individual special needs with respect to culture
                                    and tradition and
                                    prepare innovative design solutions that are technically sound,
                ...
                <div class="col-lg-3 stickyMenu disNoneRespMenu">
                    <div>
                        <div class="px-2 py-2 sideMenuDept sideMenu sideMenuArch">
                            ...
                            <div class="p-3 sideMenuBottomBorder">
                                <a href="about.aspx" class="textdecorationNone activeSideMenu sideMenuHover  d-flex ">
                                    About</a>
                            </div>
