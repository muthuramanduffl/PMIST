  ...
  <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/pushbar.js@1.0.0/src/pushbar.min.css" />
     <link href="https://use.fontawesome.com/5ecf78f4a4.css" media="all" rel="stylesheet" />
      ...
      <link rel="stylesheet" href="https://pmu.edu/alumni/css/alumni.css">
            ...
            <div>
                <div>
                    <div class="d-flex justify-content-center align-items-center mb-4">
                        ...
                        <h3 class="upperCase blueColor py-3 m-0">Proud Alumni</h3>
                    ...
                    <!-- <div class="d-flex">
                        <h3 class="blueColor Oswald OswaldR upperCase pr-3">PMAA Officer Bearers</h3>
                        <div class="headingAfter"></div>
                    </div> -->
                    <div class="profileSection pt-4 libraryBorder container-fluid">
                        <div>
                            <div class="d-flex">
                                <h3 class="blueColor Oswald OswaldR upperCase pr-3"><img src="https://pmu.edu/alumni/images/alumni-icon.png"> Department of Computer Science and Engineering</h3>
                            </div>
                        </div>
                        <div class="col-lg-12 row mt-4">
                            <div class="col-xl-2 col-lg-3 col-sm-4">
                                <div class="alumni-list-img">
                                    <div class="alumni-list-img__img">
                                        <img src="https://pmu.edu/alumni/alumni/CSE/Dhanalakshmi-Arumugam.png" class="w-100">
                                    </div>
                                    <h5 class="blueColor oswaldR Oswald pt-2"> 
                                        <span class="blueBottomBorder pb-1 w-100 d-block text-center f-14"> 
                                            Ms. Dhanalakshmi Arumugam, IAS
                                        </span>
                                        <div style="letter-spacing: 0px;" class="batch-text text-center pt-1 f-14">Batch : 1988 - 1992</div> 
                                    </h5>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-sm-4">
                                <div class="alumni-list-img">
                                    <div class="alumni-list-img__img">
                                        <img src="https://pmu.edu/alumni/alumni/CSE/Imayavaramban.jpg" class="w-100">
                                    </div>
                                    <h5 class="blueColor oswaldR Oswald pt-2"> 
                                        <span class="blueBottomBorder pb-1 w-100 d-block text-center f-14"> 
                                            Lt.R.Imayavaramban 
                                        </span>
                                        <div style="letter-spacing: 0px;" class="batch-text text-center pt-1 f-14">Batch : 2012 - 2012</div> 
                                    </h5>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-sm-4">
                                <div class="alumni-list-img">
                                    <div class="alumni-list-img__img">
                                        <img src="https://pmu.edu/alumni/alumni/CSE/Suria-R-Asai.jpg" class="w-100">
                                    </div>
                                    <h5 class="blueColor oswaldR Oswald pt-2"> 
                                        <span class="blueBottomBorder pb-1 w-100 d-block text-center f-14"> 
                                            Suria R Asai
                                        </span>
                                        <div style="letter-spacing: 0px;" class="batch-text text-center pt-1 f-14">Batch : 1991 - 1995</div> 
                                    </h5>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-sm-4">
                                <div class="alumni-list-img">
                                    <div class="alumni-list-img__img">
                                        <img src="https://pmu.edu/alumni/alumni/CSE/Hemalatha-Sarvesan.jpg" class="w-100">
                                    </div>
                                    <h5 class="blueColor oswaldR Oswald pt-2"> 
                                        <span class="blueBottomBorder pb-1 w-100 d-block text-center f-14"> 
                                            Hemalatha Sarvesan
                                        </span>
                                        <div style="letter-spacing: 0px;" class="batch-text text-center pt-1 f-14">Batch : 1990 - 1994</div> 
                                    </h5>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-sm-4">
                                <div class="alumni-list-img">
                                    <div class="alumni-list-img__img">
                                        <img src="https://pmu.edu/alumni/alumni/CSE/Viji-Selvam.jpg" class="w-100">
                                    </div>
                                    <h5 class="blueColor oswaldR Oswald pt-2"> 
                                        <span class="blueBottomBorder pb-1 w-100 d-block text-center f-14"> 
                                            Viji Selvam
                                        </span>
                                        <div style="letter-spacing: 0px;" class="batch-text text-center pt-1 f-14">Batch : 1989 - 1993</div> 
                                    </h5>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-sm-4">
                                <div class="alumni-list-img">
                                    <div class="alumni-list-img__img">
                                        <img src="https://pmu.edu/alumni/alumni/CSE/Gaiyathri.jpg" class="w-100">
                                    </div>
                                    <h5 class="blueColor oswaldR Oswald pt-2"> 
                                        <span class="blueBottomBorder pb-1 w-100 d-block text-center f-14"> 
                                            Gaiyathri P
                                        </span>
                                        <div style="letter-spacing: 0px;" class="batch-text text-center pt-1 f-14">Batch : 2005 - 2009</div> 
                                    </h5>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-sm-4">
                                <div class="alumni-list-img">
                                    <div class="alumni-list-img__img">
                                        <img src="https://pmu.edu/alumni/alumni/CSE/Ambal-Saravanan.jpg" class="w-100">
                                    </div>
                                    <h5 class="blueColor oswaldR Oswald pt-2"> 
                                        <span class="blueBottomBorder pb-1 w-100 d-block text-center f-14"> 
                                            Ambal Saravanan
                            ...
                            <div class="col-xl-2 col-lg-3 col-sm-4">
                                <div class="alumni-list-img">
                                    <div class="alumni-list-img__img">
                                        <img src="https://pmu.edu/alumni/alumni/CSE/Mr-Avinash-Kumar.png" class="w-100">
                                    </div>
                                    <h5 class="blueColor oswaldR Oswald pt-2"> 
                                        <span class="blueBottomBorder pb-1 w-100 d-block text-center f-14"> 
                                            Mr.Avinash Kumar
                                        </span>
                                        <div style="letter-spacing: 0px;" class="batch-text text-center pt-1 f-14">Batch : 2008 - 2012</div> 
                                    </h5>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-sm-4">
                                <div class="alumni-list-img">
                                    <div class="alumni-list-img__img">
                                        <img src="https://pmu.edu/alumni/alumni/CSE/Aishwarya-Shekar.png" class="w-100">
                                    </div>
                                    <h5 class="blueColor oswaldR Oswald pt-2"> 
                                        <span class="blueBottomBorder pb-1 w-100 d-block text-center f-14"> 
                                            Ms.Aishwarya Shekar
                            ...
                            <div class="col-xl-2 col-lg-3 col-sm-4">
                                <div class="alumni-list-img">
                                    <div class="alumni-list-img__img">
                                        <img src="https://pmu.edu/alumni/alumni/CSE/Rasika-M.jpg" class="w-100">
                                    </div>
                                    <h5 class="blueColor oswaldR Oswald pt-2"> 
                                        <span class="blueBottomBorder pb-1 w-100 d-block text-center f-14"> 
                                            Ms. Rasika M
                                        </span>
                                        <div style="letter-spacing: 0px;" class="batch-text text-center pt-1 f-14">Batch : 2013 - 2017</div> 
                                    </h5>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-sm-4">
                                <div class="alumni-list-img">
                                    <div class="alumni-list-img__img">
                                        <img src="https://pmu.edu/alumni/alumni/CSE/Manikandan-G.jpg" class="w-100">
                                    </div>
                                    <h5 class="blueColor oswaldR Oswald pt-2"> 
                                        <span class="blueBottomBorder pb-1 w-100 d-block text-center f-14"> 
                                            Mr.Manikandan G
                            ...
                            <div class="col-xl-2 col-lg-3 col-sm-4">
                                <div class="alumni-list-img">
                                    <div class="alumni-list-img__img">
                                        <img src="https://pmu.edu/alumni/alumni/CSE/Sadhana.jpg" class="w-100">
                                    </div>
                                    <h5 class="blueColor oswaldR Oswald pt-2"> 
                                        <span class="blueBottomBorder pb-1 w-100 d-block text-center f-14"> 
                                            V.Sadhana
                                        </span>
                                        <div style="letter-spacing: 0px;" class="batch-text text-center pt-1 f-14">Batch : 2002 - 2006</div> 
                                    </h5>
                                </div>
                            </div>
                        </div>
