<%@ Page Language="C#" AutoEventWireup="true" CodeFile="facilities.aspx.cs" Inherits="department_of_computer_science_engineering_facilities" %>
  ...
  <div class="container">
    <div class="navi">
      <ul class="navi-link">
        ...
        <li><a href="/cse/facilities.aspx">Facilities</a></li>
      </ul>
    </div>
    <div class="content-left">
      ...
      <article class="content-1">
        ...
        <ul class="content-list">
          <p><b>Multimedia Lab</b></p>
          <li>Perform Experiments on Graphics , Photoshop,Visual programming and Multimedia using licensed software.</li>
          <p><b>Lab1</b></p>
          <li>Perform Experiments on Database Management systems, Case tools and Data structures applications using licensed software.</li>
          <p><b>Lab2</b></p>
          <li>Perform Experiments on Network Programming, Network application, C,C++ and Java applications using licensed software.</li>
          <p><b>Lab3</b></p>
          <li>Separately Used for PG Research activities and Lab Experiments.</li>
        </ul>
      </article>
    </div>
