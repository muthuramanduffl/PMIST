<%@ Page Language="C#" AutoEventWireup="true" CodeFile="placements.aspx.cs" Inherits="department_of_computer_science_engineering_placements" %>
  ...
  <div class="container">
    <div class="navi">
      <ul class="navi-link">
        ...
        <li><a href="cse/placements.aspx">Placements</a></li>
      </ul>
    </div>
    <div class="content-left">
      ...
      <article class="content-1">
        ...
        <ul class="content-list">
          <li>Computing Science and Engineering and the Centre for University Industry Interaction actively   working together for Students placement and Career development through   Training on Soft skills like aptitude ,verbal, nonverbal  reasoning, industrial  visits, project demonstrations and seminars. Many leading companies like CTS,Vdart(HCL)  recruit the students of school of Computing Sciences and Engineering every year. </li>
          <li>Computing Science and Engineering and the Centre for University Industry Interaction arranges for concrete Inplant Training for students. </li>
        </ul>
      </article>
    </div>
