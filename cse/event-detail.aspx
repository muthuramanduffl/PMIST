<%@ Page Language="C#" AutoEventWireup="true" CodeFile="event-detail.aspx.cs" Inherits="department_of_architecture_new_event_detail" %>
...
<uc3:socialmediasharefloated runat="server" ID="socialmediasharefloated" />
        ...
        <div class="swiper-container menuSwiper py-3">
            <div class="placementBorderBottom swiper-wrapper ">
                <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                    <a href="/cse/default.aspx" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block  ">
                        Home
                    </a>
                </div>
                <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2 ">
                    <a  href="/cse/about.aspx" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block  ">
                        About
                    </a>
                </div>
                <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                    <a href="/cse/courses.aspx" class="blackColor textdecorationNone  sideMenuHover pb-1  d-block ">
                        Programs
                    </a>
                </div>

                <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                    <a href="/cse/faculty.aspx" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">
                        Faculty
                    </a>
                </div>
                ...
                <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                    <a href="/cse/infrastructure.aspx" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">
                        Infrastructure
                    </a>
                </div>
                <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                    <a href="/cse/activities.aspx" class="blackColor textdecorationNone  sideMenuHover pb-1  d-block ">
                        Activities
                    </a>
                </div>
                <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2 activeBorderBottom">
                    <a href="/cse/events.aspx" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block  ">
                        Events
                    </a>
                </div>
                <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                    <a href="/cse/gallery.aspx" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">
                        Gallery
                    </a>
                </div>
                <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                    <a href="/cse/placement.aspx" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">
                        Placement
                    </a>
                </div>
                <div class="px-3 py-1 placementBorder swiper-slide widthAuto pb-2">
                    <a href="/cse/accolades.aspx" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">
                        Accolades
                    </a>
                </div>

                <div class="px-3 py-1  pb-2 placementBorder swiper-slide widthAuto">
                    <a href="/cse/research.aspx"
                ...
                <div class="px-3 py-1  pb-2  swiper-slide widthAuto">
                    <a href="/cse/faqs.aspx" class="blackColor textdecorationNone  sideMenuHover pb-1  d-block ">
                        FAQs
                    </a>
                </div>
    ...
    <div class="pt-4 container">
        <div>
            <div class="row mx-0 eventsPageBottom pb-3 align-items-center">
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 my-3">
                    <div class="blueColor pr-3  oswaldR Oswald text-center">
                        <div class="upperCase lt-2">
                            <h5 class=""> <span class="blueBottomBorder pb-2"><asp:Label ID="lblEventMonthYear" runat="server"></asp:Label> </span></h5>
                        </div>
                        <div class="pt-3">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 my-3">
                    <div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 my-3 d-flex justify-content-center">
                    <div>
                        <div class="blueColor pr-3  oswaldR Oswald text-center">
                            <h6 class="blueColor  ">
                                <asp:Label ID="lblDepartment" runat="server"></asp:Label></h6>
                        </div>
                    </div>
                </div>

            </div>
            <div class="eventsImage d-flex justify-content-center pt-4">
                <asp:PlaceHolder ID="phEventImage" runat="server"></asp:PlaceHolder>
                <%--<img src="https://pmu.edu/events/images/workshop.png" class="eventsImage w-100" />--%>
            </div>
            <div class="eventsDescription lsp-08 f-14 pt-4">
            ...
            <div class="mt-2 py-4 eventsMarginTop">
                <div class="d-flex justify-content-between">
                    <div>
                         <asp:PlaceHolder ID="phPrevious" runat="server"></asp:PlaceHolder>
                    </div>
                    <div>
                        <a href="https://pmu.edu/cse/events.aspx" class="textdecorationNone blueColor upperCase  ">
                            Go to Event index
                        </a>
                    </div>
                    <div>
                         <asp:PlaceHolder ID="phNext" runat="server"></asp:PlaceHolder>
                    </div>
                </div>
            </div>
...
<!-- Script  -->
<script type="text/javascript" src="https://pmu.edu/js/bootstrap.min.js"></script>
<script type="text/javascript" src="https://pmu.edu/js/jquery-3.4.1.min.js"></script>
<script type="text/javascript" src="https://pmu.edu/js/swiper.min.js"></script>
