<%@ Page Language="C#" AutoEventWireup="true" CodeFile="events.aspx.cs" Inherits="department_of_architecture_new_events" %>
...
<uc3:socialmediasharefloated runat="server" ID="socialmediasharefloated" />
    ...
    <div class="pt-4 container-fluid">
        ...
        <div class="d-flex justify-content-center mb-3 align-items-center">
            ...
            <h3 class="upperCase blueColor py-2 m-0  ">Events </h3>
            <div class="headingAfter mt-1 ml-3"></div>

        </div>
         <div id="dvEvents" runat="server" style="display:block">
            <h2>Coming Soon!</h2>
            </div>
        <div id="dvEvents1" runat="server" style="display:none">
        ...
        <div class="row mx-0 eventsPageBottom lsp-08 pb-3">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 my-1">
                <div class="blueColor pr-3  oswaldR Oswald text-center">
                    <div class="upperCase lt-2">
                        <h5 class=""> <span class="blueBottomBorder pb-2"> <%# bindEventMonthYear(System.Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "EventStartDate")))%>  </span></h5>
                    </div>
                    <div class="pt-3">
                        <h6><%# bindEventDate(System.Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "EventStartDate")),System.Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "EventEndDate")))%> </h6>
                    </div>
                </div>
            </div>
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 my-1">
                <div>

                    <h5 class="  pt-2"><%#Eval("Title")%>
                        </h5>
                    <div class="pt-2 f-14">
                         <%#Eval("ShortAbstract")%>
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 my-2 d-flex align-items-end justify-content-center">
                <div>
                    <div class="blueColor pr-3  oswaldR Oswald text-center">
                        <a  class="textdecorationNone blackColor">
                            <h6 class="upperCase  "> <span class="position-relative moreLinkAfter"><%# bindMore(System.Convert.ToInt32(DataBinder.Eval(Container.DataItem, "EventId")),System.Convert.ToString(DataBinder.Eval(Container.DataItem, "Title")))%>
                                </span></h6>
                        </a>
                    </div>
                </div>
...
<script type="text/javascript" src="../js/departmentpagination.js"></script>
