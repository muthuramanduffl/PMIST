<%@ Page Language="C#" AutoEventWireup="true" CodeFile="placement.aspx.cs" Inherits="department_of_architecture_new_placement" %>
                ...
                <div class="col-lg-9 col-sm-12 col-md-12 col-xs-12 ">
                    <div class="profileSection pt-4 libraryBorder">
                        <div class="container-fluid  py-2">
                            <div class="d-flex">
                                <h3 class="blueColor   upperCase pr-3 mb-0 "> Placement</h3>
                        ...
                        <div class="container-fluid">
                            ...
                            <div>
                                <ul class="customli pt-4">
                                    <li class="lh-2">
                                        Department of Computer Science and Engineering upgrades 
                                        the knowledge of every student in both technical and soft skill areas. 

                                    </li>
                                    <li class="pt-2 lh-2">
                                        Soft Skills Training including Communication & Personality Development 
                                        and aptitude training are offered to all students from First year to 
                                        Final year students by Industrial experts.

                                    </li>
                                    <li class="pt-2 lh-2">
                                        Coaching given for GATE, TANCET, GRE, GMAT, IELTS, TOEFL etc. for 
                                        students aspiring for higher studies and employment.

                                    </li>
                                    <li class="pt-2 lh-2">
                                        Compulsory In-Plant Training in Industries for 15 days, 21 days and 30 days 
                                        for I year, II year and III year respectively assigning due credits.
                                    </li>
                                ...
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <div class="d-flex pt-2 align-items-center">
                                            ...
                                            <div>
                                               <a href="pdf/2017-2021.pdf" class="blackColor textdecorationNone" target="_blank">Placement Report - 2017 - 2021</a>
                                            </div>
                                        </div>
                                        <div class="d-flex pt-2 align-items-center">
                                            <div class="mr-3">
                                            ...
                                            <div>
                                               <a href="pdf/2018-2022.pdf" class="blackColor textdecorationNone" target="_blank"> Placement Report - 2018 - 2022</a>
                                            </div>
                                        </div>
                                        <div class="d-flex pt-2 align-items-center">
                                            <div class="mr-3">
                                            ...
                                            <div>
                                               <a href="pdf/2019-2023.pdf" class="blackColor textdecorationNone" target="_blank"> Placement Report - 2019 - 2023</a>
                                            </div>
                                        </div>
                            ...
                            <div class="mt-4 ml-2">
                                <div class="f-18 lh-1-8 blueColor  pb-3">Industrial Visits</div>
                                <ul class="customli ">
                                    <li class="pt-2 lh-2">
                                        Students of Batch 2022-26 visited Trade Center, Chennai – Umagine Chennai on 23rd and 24th March2023
                                       </li>
                                       <li class="pt-2 lh-2">
                                        Students of Batch 2021-25 visited the Keeladi Heritage Museum, Madurai on 27th March 2023
                                       </li>
                                       <li class="pt-2 lh-2">
                                        Students of Batch 2022-26 visited Trade Center, Chennai – Umagine Chennai on 23rd and 24th March2023
                                       </li>
                                       <li class="pt-2 lh-2">
                                        Students of Batch 2019-23 visited Monzha Research Labs, Kinfra Hi-Tech Park, Kalamassery, Kochi, Kerala and UST Global, World Trade center, Infopark, Kochi, Kerala on  10th and 11th  September 2023.
                                       </li>   
                                </ul>
                            </div>
                            ...
                            <div class="pt-1">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-12 py-1">
                                        <div>
                                            <img src="images/industrialvisit/1.jpeg" style="width: 100%; height: auto;">
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 py-1">
                                        <div>
                                            <img src="images/industrialvisit/2.jpeg" style="width: 100%; height: auto;">
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 py-1">
                                        <div>
                                            <img src="images/industrialvisit/3.jpeg" style="width: 100%; height: auto;">
                                        </div>
                    ...
                    <div>
                        <div class="px-2 py-2 sideMenuDept sideMenu sideMenuArch">
                            <div class="p-3 sideMenuBottomBorder">
                                <a href="index.aspx" class="textdecorationNone sideMenuHover  d-flex ">
                                    Home</a>
                            </div>
                            <div class="p-3 sideMenuBottomBorder">
                            ...
                            <div class="p-3 pt-4 sideMenuBottomBorder">
                                <a  class="textdecorationNone sideMenuHover activeSideMenu d-flex ">
                                    Placements</a>
                            </div>
                            <div class="p-3 pt-4 sideMenuBottomBorder">
