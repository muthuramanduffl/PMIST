...
<body>
    <form id="form1" runat="server">
        ...
        <section class="academic-index sub-menu">
            <div class="navigationSection  placementBg">
                <div class="swiper-container menuSwiper  swiper-container-initialized swiper-container-horizontal">
                    <div class="placementBorderBottom swiper-wrapper " style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto  activeBorderBottom swiper-slide-active">
                            <a href="index.html" class=" blackColor textdecorationNone sideMenuHover  pb-1  d-block  ">Home
                            </a>
                        </div>
                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto  swiper-slide-next">
                            <a href="about.html" class="  blackColor textdecorationNone  sideMenuHover pb-1  d-block  ">About
                            </a>
                        </div>
                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto ">
                            <a href="programs.html" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">Programs
                            </a>
                        </div>

                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto ">
                            <a href="faculty.html" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">Faculty
                            </a>
                        </div>


                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto ">
                            <a href="Infrastructure-type-three.html" class="blackColor textdecorationNone  sideMenuHover pb-1  d-block ">Infrastructure
                            </a>
                        </div>
                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto ">
                            <a href="activities.html" class=" active blackColor textdecorationNone  sideMenuHover pb-1  d-block ">Activities
                            </a>
                        </div>
                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto ">
                            <a href="event.html" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">Events
                            </a>
                        </div>
                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto ">
                            <a href="gallery.html" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">Gallery
                            </a>
                        </div>
                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto ">
                            <a href="placement.html" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">Placement
                            </a>
                        </div>
                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto ">
                            <a href="accolades.html" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">Accolades
                            </a>
                        </div>

                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto">
                            <a href="research.html" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">Research
                            </a>
                        </div>

                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto">
                            <a class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">MOU
                            </a>
                        </div>
                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto">
                            <a href="alumni.html" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">Alumni Corner
                            </a>
                        </div>
                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto">
                            <a href="faq.html" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">FAQs
                            </a>
                        </div>
                        <div class="px-sm-3 px-2  placementBorder swiper-slide widthAuto">
                            <a href="" class="blackColor textdecorationNone sideMenuHover  pb-1  d-block ">Contact
                            </a>
                        </div>
                    </div>
            ...
            <div class="custom-container">
                <div class="full-page position-relative">
                    ...
                    <asp:Repeater ID="Repeater1" ClientIDMode="Static" runat="server">
                        <ItemTemplate>
                            <div class="align-items-start list-tick mb-3">
                                <%# Eval("Content")%>
                            </div>
                        </ItemTemplate>
                    </asp:Repeater>
