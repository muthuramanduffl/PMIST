...
$(function () {
    "use strict";
    altair_page_onload.init(), altair_main_header.init(), altair_main_sidebar.init(), altair_secondary_sidebar.init(), altair_top_bar.init(), altair_md.init(), altair_forms.init(), altair_helpers.truncate_text($(".truncate-text"))
...
altair_page_onload = {
    ...
    select_elements: function () {
        var e = $("[data-md-selectize],.data-md-selectize");
        e.each(function () {
            var e = $(this);
    ...
    parsley_extra_validators: function () {
        window.ParsleyConfig = window.ParsleyConfig || {}, window.ParsleyConfig.validators = window.ParsleyConfig.validators || {}, window.ParsleyConfig.validators.americandate = {
            fn: function (e) {
                if (!/^([01]?[1-9])[.\/-]([0-3]?[0-9])[.\/-]([0-9]{4}|[0-9]{2})$/.test(e)) return !1;
                var i = e.split(/[.\/-]+/),
                    a = parseInt(i[1], 10),
                    t = parseInt(i[0], 10),
                    n = parseInt(i[2], 10);
    ...
    init: function () {
        $body.hasClass("sidebar_mini") || null !== localStorage.getItem("altair_sidebar_mini") ? (altair_main_sidebar.mini_sidebar(), setTimeout(function () {
            $window.resize()
    ...
    main_menu: function () {
        $sidebar_main.find(".menu_section > ul").children("li").each(function () {
            ...
            i.next("ul").velocity(a, {
                ...
                complete: function () {
                    //if ("slideUp" !== a) {
                    //    var e = $sidebar_main.find($sidebar_main.find(".scroll-content").length ? ".scroll-content" : ".scrollbar-inner");
    ...
    init: function () {
        ...
        }), $body.hasClass("sidebar_secondary_active") && altair_secondary_sidebar.hide_sidebar(), altair_helpers.custom_scrollbar($sidebar_secondary))
    },
    hide_sidebar: function () {
    ...
    init: function () {
        altair_main_header.search_activate(), $("#menu_top").children().on("show.uk.dropdown", function (e) {
            setTimeout(function () {
                $window.resize()
            }, 320)
        })
    ...
    init: function () {
        altair_md.inputs(), altair_md.checkbox_radio(), altair_md.card_fullscreen(), altair_md.card_expand(), altair_md.card_overlay(), altair_md.card_single(), altair_md.list_outside(), altair_md.fab_actions()
    },
    ...
    inputs: function (e) {
        ...
        i.each(function () {
            ...
            $body.on("focus", ".md-input", function () {
                ...
                $(this).closest(".md-input-wrapper").removeClass("md-input-focus"), "" != $(this).val() ? $(this).closest(".md-input-wrapper").addClass("md-input-filled") : $(this).closest(".md-input-wrapper").removeClass("md-input-filled")
    ...
    update_input: function (e) {
        e.closest(".md-input-wrapper").removeClass("md-input-wrapper-danger md-input-wrapper-success md-input-wrapper-disabled"), e.hasClass("md-input-danger") && e.closest(".md-input-wrapper").addClass("md-input-wrapper-danger"), e.hasClass("md-input-success") && e.closest(".md-input-wrapper").addClass("md-input-wrapper-success"), e.prop("disabled") && e.closest(".md-input-wrapper").addClass("md-input-wrapper-disabled"), "" != e.val() && e.closest(".md-input-wrapper").addClass("md-input-filled")
    },
    fab_actions: function () {
        $(".md-fab-actions").append('<i class="material-icons md-fab-action-close" style="display:none">&#xE5CD;</i>').on("click", function () {
            var e = $(this);
            e.closest(".md-fab-wrapper").hasClass("md-fab-active") ? e.closest(".md-fab-wrapper").removeClass("md-fab-active") : e.closest(".md-fab-wrapper").addClass("md-fab-active"), e.velocity({
                scale: 0
            }, {
                duration: 140,
                easing: easing_swiftOut,
    ...
    custom_scrollbar: function (e) {
        e.wrapInner("<div class='scrollbar-inner'></div>"), Modernizr.touch ? e.children(".scrollbar-inner").addClass("touchscroll") : e.children(".scrollbar-inner").scrollbar({
            disableBodyScroll: !0,
            scrollx: !1,
            duration: 100
        })
    ...
    hierarchical_slide: function () {
        $hierarchical_slide = $(".hierarchical_slide"), $hierarchical_slide.length && $hierarchical_slide.each(function () {
            var e = $(this),
                ...
                a = i.length,
                t = e.attr("data-slide-context") ? e.closest(e.attr("data-slide-context")) : "window",
                n = 100;
