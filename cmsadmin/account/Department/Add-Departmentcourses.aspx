<%@ Page Title="" Language="C#" MasterPageFile="~/cmsadmin/account/accountMaster.master" AutoEventWireup="true" CodeFile="Add-Departmentcourses.aspx.cs" Inherits="cmsadmin_account_Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageContent" runat="Server">
                        ...
                        <div class="uk-width-large-2-3 resize-width">
                            <div class="d-flex " style="flex-wrap: wrap; justify-content: start; column-gap: 26px;">
                                ...
                                <div class="d-flex resize two-box">
                                    <div class="  uk-grid uk-grid-small doctorateduplicate" style="position: relative; width: 100%;" id="doctoraterow">
                                        <div class="uk-width-large-3-3 d-flex align-items-center">
                                            <div class="flex-grow-1 col-4" style="margin-bottom: 4px;">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="remove-more-btn-doctorate" style="display: none;">
                                                    <p class="minus btn-remove">x</p>
                                                </div>
                                            </div>
                                        </div>

                                    </div>
                                    <div id="divplus" runat="server">
                                        <p class="btn-add plus" id="doctoratebutton">+</p>
                                    </div>
                                </div>
                            ...
                            <div class=" d-flex flex-column" style="flex-direction: column;">
                                ...
                                <div class="full-width">
                                    ...
                                    <div class="" runat="server" id="divPOintro">
                                        <div class="" style="padding-bottom: 30px;">
                                            <label>Introduction*</label>
                                            <div class="md-input-wrapper" id="Div1" runat="server" style="padding-top: 9px">
                                                <asp:TextBox ID="txtindroductionPO" Style="border-width: 2px 2px 2px;" CssClass="md-input form-input" runat="server"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ForeColor="Red" CssClass="mt-2 required-validator" runat="server" ErrorMessage="Enter introduction" ControlToValidate="txtindroductionPO" ValidationGroup="val"></asp:RequiredFieldValidator>
                                                <span class="md-input-bar"></span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="uk-grid uk-grid-small full-width  doctorateduplicatepo" id="doctoraterowPO">
                                            <div class="uk-width-large-3-3 d-flex align-items-center">
                                                <div class="flex-grow-1 col-4">
                                                    <label for="txtSO">Program Outcomes *</label>
                                                    <div class="md-input-wrapper" id="Div2" runat="server" style="padding-top: 12px">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ForeColor="Red" CssClass="mt-2 required-validator" runat="server" ErrorMessage="Enter Program Outcomes" ControlToValidate="txtpo" ValidationGroup="val"></asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
                                ...
                                <hr />
                                <div class="full-width">
                                    <div class="" runat="server" id="divPEOintro">
                                        <div class="" style="padding-bottom: 30px;">
                                            <label>Introduction *</label>
                                            <div class="md-input-wrapper" id="Div5" runat="server" style="padding-top: 9px">
                                                <asp:TextBox ID="txtindroductionPEO" Style="border-width: 2px 2px 2px;" CssClass="md-input form-input" runat="server"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ForeColor="Red" CssClass="mt-2 required-validator" runat="server" ErrorMessage="Enter introduction" ControlToValidate="txtindroductionPEO" ValidationGroup="val"></asp:RequiredFieldValidator>
                                                <span class="md-input-bar"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex full-width">
                                        <div class="uk-grid uk-grid-small full-width doctorateduplicatePEO" id="doctoraterowPEO">
                                            <div class="uk-width-large-3-3 d-flex align-items-center">
                                                <div class="flex-grow-1 col-4">
                                                    <label for="txtPEO">Programme Educational Objectives *</label>
                                                    <div class="md-input-wrapper" id="Div3" runat="server" style="padding-top: 12px">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ForeColor="Red" CssClass="mt-2 required-validator" runat="server" ErrorMessage="Programme educational objectives" ControlToValidate="TXTPEO" ValidationGroup="val"></asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
                                ...
                                <div class="full-width">
                                    <div class="" runat="server" id="divPSOintro">
                                        <div class="" style="padding-bottom: 30px;">
                                            <label>Introduction *</label>
                                            <div class="md-input-wrapper" id="Div6" runat="server" style="padding-top: 9px">
                                                <asp:TextBox ID="txtindroductionPSO" Style="border-width: 2px 2px 2px;" CssClass="md-input form-input" runat="server"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" ForeColor="Red" CssClass="mt-2 required-validator" runat="server" ErrorMessage="Enter introduction" ControlToValidate="txtindroductionPSO" ValidationGroup="val"></asp:RequiredFieldValidator>
                                                <span class="md-input-bar"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex full-width ">
                                        <div class="uk-grid uk-grid-small full-width doctorateduplicatePSO" id="doctoraterowPSO">
                                            <div class="uk-width-large-3-3 d-flex align-items-center">
                                                <div class="flex-grow-1 col-4">
                                                    <label for="txtPSO">Program Specific Outcome *</label>
                                                    <div class="md-input-wrapper" id="Div4" runat="server" style="padding-top: 12px">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ForeColor="Red" CssClass="mt-2 required-validator" runat="server" ErrorMessage="Enter Program Specific Outcome" ControlToValidate="TXTPSO" ValidationGroup="val"></asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
    ...
    font-size: 20px;">Curriculum: </label>
                            </div>
                            ...
                            <div id="fileUploadContainer">
                                ...
                                <div class="d-flex full-width" id="fileUploadRow1">

                                    <div class="file-upload-row full-width" style="display: flex; justify-content: space-between; margin-bottom: 10px; flex-wrap: wrap; padding-top: 20px;">
                                        <div class="resize first-box">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" ForeColor="Red" CssClass="mt-2 required-validator" runat="server" ErrorMessage="Enter curriculum" ControlToValidate="textBox" ValidationGroup="val"></asp:RequiredFieldValidator>
                                        </div>



                                        <div class="resize two-box">
                                            <label for="fileUpload" class="MT-5">Choose file (PDF only, max 1 MB) </label>
                                            <div class="md-input-wrapper ml-5 " style="flex: 1;">

                                                <asp:FileUpload type="file" ClientIDMode="Static" ID="fileUpload" class="md-input form-input" accept=".pdf" onchange="handleFileUpload(this)" runat="server" Style="border: 1px solid #d2d2d2; padding: 11px 3px; width: 100%;"></asp:FileUpload>
                                            </div>
                                    ...
                                    <p type="button" class="remove-btn minus" style="margin-top: 8px;">x</p>

                                    <div runat="server" id="divfileadd">
                                        <p id="addFileUploadBtn" class="plus">+</p>
                                    </div>
                                </div>
                            ...
                            <div class="uk-grid uk-grid-small" style="padding-top: 30px;">
                                <div class="uk-width-large-3-3">
                                    ...
                                    <a class="md-btn md-btn-small md-btn-flat md-btn-warning " href="viewDepartmentcourses.aspx">View</a>
                                </div>
                            </div>
