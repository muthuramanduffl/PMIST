<%@ Page Title="" Language="C#" MasterPageFile="~/cmsadmin/account/accountMaster.master" AutoEventWireup="true" CodeFile="Add-Departmentcourses old 26 11.aspx.cs" Inherits="cmsadmin_account_Default" %>
                    ...
                    <div class="uk-grid uk-grid-divider uk-grid-medium">
                        <div class="uk-width-large-2-3 resize-width">
                                        ...
                                        <div class="uk-width-large-3-3 d-flex align-items-center">
                                            <div class="flex-grow-1 col-4" style="margin-bottom: 4px;">
                                                ...
                                                <div class="md-input-wrapper" id="dvPO" runat="server" style="padding-top: 12px">
                                                    <asp:TextBox ID="txtProgrammeOffered" Rows="10" TextMode="MultiLine" ClientIDMode="Static" runat="server" CssClass="md-input form-input" Style="border-width: 2px 2px 2px;"></asp:TextBox>
                            ...
                            <div class=" d-flex flex-column" style="flex-direction: column;">
                                <div class="uk-grid uk-grid-small full-width">
                                    <div class="uk-width-large-3-3">
                                        ...
                                        <div class="uk-width-large-3-3 d-flex align-items-center">
                                            <div class="flex-grow-1 col-4">
                                                ...
                                                <div class="md-input-wrapper" id="Div2" runat="server" style="padding-top: 12px">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ForeColor="Red" CssClass="mt-2 required-validator" runat="server" ErrorMessage="Enter po" ControlToValidate="txtindroduction" ValidationGroup="val"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                ...
                                <div id="dgadd1" style="width: 100%;"></div>
                                ...
                                <div id="dgadd2" style="width: 100%;"></div>
                                ...
                                <div id="dgadd3" style="width: 100%;"></div>
                                <!-- Container to append new cloned rows -->
                            ...
                            <div id="fileUploadContainer">
                                ...
                                <div class="d-flex full-width" id="fileUploadRow1">
                                    ...
                                    <div class="file-upload-row full-width" style="display: flex; justify-content: space-between; margin-bottom: 10px; flex-wrap: wrap;">
