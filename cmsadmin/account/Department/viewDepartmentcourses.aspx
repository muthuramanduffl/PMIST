<%@ Page Title="" Language="C#" MasterPageFile="../accountMaster.master" AutoEventWireup="true" CodeFile="viewDepartmentcourses.aspx.cs" Inherits="admin_account_about_ViewNews" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link rel="stylesheet" href="https://code.jquery.com/ui/1.13.2/themes/base/jquery-ui.css">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageHeading" runat="Server">
    <h1>View Department Courses</h1>
</asp:Content>
        ...
        <div class="uk-width-xLarge-1-1  uk-width-large-1-1">
            <div class="md-card">
                <div class="md-card-toolbar " style="display: flex; justify-content: space-between; height: auto; flex-wrap: wrap;">
                    ...
                    <div>
                        <h3 class="md-card-toolbar-heading-text"><b>View Department Courses
                    ...
                    <div class="md-card-toolbar-heading-text align-self-end">
                        <a class="btn btn-success btn-sm" href="Add-Departmentcourses.aspx">Add Department Courses</a>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                <ContentTemplate>
                                                    <asp:Repeater ID="rpruser" OnItemCommand="Repeater1_ItemCommand" runat="server">
                                                        <HeaderTemplate>
                                                            <table class="display table table-head-bg-info dataTable no-footer" id="basic-datatables" role="grid" aria-describedby="basic-datatables_info" style="border-collapse: collapse !important;">
                                                                <thead>
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td class="text-left">
                                                                    <asp:TextBox ID="txtIntroduction" TextMod="MultiLine" CssClass="w-100 border-0 input-cus dynamic-textbox" Wrap="true" runat="server" Text='<%# string.IsNullOrEmpty(Eval("Introduction").ToString()) ? "-" : Eval("Introduction")%>' ReadOnly="true" Style="background: transparent; text-align: center;" /></td>
                                                                <td class="text-left"><%# Eval("SectionName") %></td>
                                                                <td class="text-left">
                                                                    <asp:TextBox ID="txtContent" TextMode="MultiLine" CssClass="w-100 border-0 input-cus  dynamic-textbox" Wrap="true" runat="server" Text='<%# string.IsNullOrEmpty(Eval("Content").ToString()) ? "-" : Eval("Content")%>' ReadOnly="true" Style="background: transparent; text-align: center;" /></td>
                                                                <%-- <td class="text-left">
                                                                    <asp:TextBox ID="txtCurriculum" TextMode="MultiLine" CssClass="w-100 border-0 input-cus dynamic-textbox" Wrap="true" runat="server" Text=' <%# string.IsNullOrEmpty( Eval("Curriculum").ToString()) ? "-" :  Eval("Curriculum") %>' ReadOnly="true" Style="background: transparent; text-align: center;" />
                                                                </td>--%>
                                                                <td class="text-left">
                                                                    <asp:LinkButton
                                                                        ID="btnview"
                                                                        ...
                                                                        CommandName="ViewPDF"
                                                                        CssClass="md-btn md-btn-small md-btn-flat btn-info text-info pdf-cus"
                                                                    ...
                                                                    <asp:FileUpload ID="FileUpload1" Visible="false" runat="server" Style="border: 1px solid #cacaca; padding: 10px; margin: 0 10px;" />
