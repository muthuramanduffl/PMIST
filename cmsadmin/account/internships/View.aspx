...
<h1>Internships <small>(Page View)</small> </h1>
</asp:Content>
                    ...
                    <div class="uk-width-xLarge-1-1  uk-width-large-1-1">
                        <div class="md-card">
                            <div class="md-card-toolbar">
                                <h3 class="md-card-toolbar-heading-text">Dashboard - Internships - <b>View</b>
                                </h3>
                            </div>
              ...
              <Columns> 
                ...
                <ItemTemplate>
                   <asp:Label ID="lblCompanyContactNo" runat="server" Text='<%# Eval("CompanyContactNo")%>'></asp:Label>
                    ...
                    <asp:TemplateField AccessibleHeaderText="Duration" HeaderText="Duration">
                <ItemTemplate>
                   <asp:Label ID="lblDuration" runat="server" Text='<%# Eval("Duration")%>'></asp:Label>
                </ItemTemplate>
                
                 </asp:TemplateField>
                   <asp:TemplateField AccessibleHeaderText="Deliverables" HeaderText="Deliverables">
                <ItemTemplate>
                   <asp:Label ID="lblDeliverables" runat="server" Text='<%# Eval("Deliverables")%>' Width="170px"></asp:Label>
                </ItemTemplate>
