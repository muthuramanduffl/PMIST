...
<h1>Alumni <small>(Page View)</small> </h1>
</asp:Content>
...
<div class="uk-grid">
                    ...
                    <div class="uk-width-xLarge-1-1  uk-width-large-1-1">
                        <div class="md-card">
                            <div class="md-card-toolbar">
                                <h3 class="md-card-toolbar-heading-text">Dashboard - Alumni - <b>View</b>
                                </h3>
                            </div>
              ...
              <Columns> 
                ...
                <ItemTemplate>
                   <asp:Label ID="lblMobileNo" runat="server" Text='<%# Eval("MobileNo")%>'></asp:Label>
                    ...
                    <asp:TemplateField AccessibleHeaderText="CompanyName" HeaderText="Department">
                <ItemTemplate>
                   <asp:Label ID="lblDepartment" runat="server" Text='<%# Eval("Department")%>'></asp:Label>
                </ItemTemplate>
                
                 </asp:TemplateField>
                      <asp:TemplateField AccessibleHeaderText="CompanyEmailId" HeaderText="Current Status">
                <ItemTemplate>
                  ...
                  <asp:TemplateField AccessibleHeaderText="Name" HeaderText="Photo">
                <ItemTemplate>
                    <%# bindImageHref(System.Convert.ToString(DataBinder.Eval(Container.DataItem, "PhotoUrl")))%>
        ...
        <div class="uk-grid uk-grid-small">
                                            <div class="uk-width-large-3-3">
                                               <asp:Button ID="Button1" runat="server" CssClass="md-btn md-btn-small md-btn-flat md-btn-success" Text=" Add " OnClick="btnAdd_Click"   />
