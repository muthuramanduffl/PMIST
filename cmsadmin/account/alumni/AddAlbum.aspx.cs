...
public partial class admin_account_gallery_AddAlbum : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblDisplayText.Text = "Dashboard / Alumni / <b>Add/Edit Album</b>";
    ...
    public void BindAlbum()
    {
        //try
        //{
        DataSet dsAlbum = album.ViewAlbumByOnlyDepartment("Alumni");
    ...
    public bool CreateFolder(string foldername)
    {
        ...
        string path = HttpContext.Current.Server.MapPath(System.Configuration.ConfigurationManager.AppSettings["Alumniimage"]);
    ...
    {
        bool IsExist = false;
        DataSet ds = gallery.ViewAlbumByDepartment("Alumni", stAlbumName);
    ...
    public string GetDepartmentAlbum(string stDepartment)
    {
        ...
        if (string.Equals(stDepartment, "Department of MBA"))
            stAlbum = "mba";
        if (string.Equals(stDepartment, "Iqac"))
            stAlbum = "iqac";
        if (string.Equals(stDepartment, "Alumni"))
            stAlbum = "alumni";
        return stAlbum;
