...
<asp:Content ID="Content2" ContentPlaceHolderID="PageHeading" runat="Server">
    <h1>Recuritment <small>(Page Content)</small> </h1>
     <style>
    .remove {
  display: block;
  background: #444;
                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium">
                                    ...
                                    <div class="uk-grid uk-grid-small">
                                       ...
                                       <div class="uk-grid uk-grid-small">
                                        ...
                                        <div class="uk-grid uk-grid-small">
                                            <div class="uk-width-large-3-3">
                                                <div class="md-input-wrapper" id="dvDesignation" runat="server" style="padding-top:12px">
                                                    
                                                    <label style="top:10px">Designation *</label>
                                                    <br />
                                                
                                                   <asp:TextBox ID="txtDesignation" runat="server" CssClass="md-input"
                                                 autocomplete="off"></asp:TextBox>
                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"
                                                    ValidationGroup="val" Display="Dynamic" ControlToValidate="txtDesignation"
                                                    ErrorMessage="Enter your designation"></asp:RequiredFieldValidator>
                                                    <span class="md-input-bar"></span>
                                                </div>
                                            </div>
                                        </div>
                                         <div class="uk-grid uk-grid-small">
                                            <div class="uk-width-large-3-3">
                                                <div class="md-input-wrapper" id="dvJobDetails" runat="server" style="padding-top:12px">
                                                    
                                                    <label style="top:10px">Job Details *</label>
                                                    <br />
                                                
                                                   <asp:TextBox ID="txtJobDetails" runat="server" CssClass="md-input" TextMode="MultiLine"
                                                 autocomplete="off"></asp:TextBox>
                                              <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"
                                                    ValidationGroup="val" Display="Dynamic" ControlToValidate="txtJobDetails"
                                                    ErrorMessage="Enter your job details"></asp:RequiredFieldValidator>
