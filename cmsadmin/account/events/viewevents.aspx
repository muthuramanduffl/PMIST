<%@ Page Title="" Language="C#" MasterPageFile="../accountMaster.master" AutoEventWireup="true" CodeFile="viewevents.aspx.cs" Inherits="admin_account_about_ViewNews" %>
...
<div class="uk-grid">
                    ...
                    <div class="uk-width-xLarge-1-1  uk-width-large-1-1">
                        <div class="md-card">
                            <div class="md-card-toolbar">
                                <h3 class="md-card-toolbar-heading-text">Dashboard / Events / <b>View Events List <asp:Label ID="lblDisplayText" runat="server"></asp:Label></b>
        ...
        <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
              ...
              <asp:Label ID="lblTitle" runat="server" Text='<%# Eval("Title")%>'></asp:Label>
                ...
                <ItemTemplate>
              <asp:Label ID="lblDescription" runat="server" Text='<%# Eval("ShortAbstract")%>'></asp:Label>
                </ItemTemplate>
              ...
              <asp:Label ID="lblDepartment" runat="server" Text='<%# Eval("Department")%>'></asp:Label>
                ...
                <ItemTemplate>
                    <asp:Label ID="lblEventStartDateTime" runat="server" Text='<%# bindDate( System.Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "EventStartDate"))) %>'></asp:Label>
                      ...
                      <asp:TemplateField AccessibleHeaderText="Name" HeaderText="Event End Date" HeaderStyle-Width="70px" >
                <ItemTemplate>
                    <asp:Label ID="lblEventEndDateTime" runat="server" Text='<%# bindDate( System.Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "EventEndDate"))) %>'></asp:Label>
                </ItemTemplate>
        ...
        <a href='addevents.aspx?ID=<%# Eval("EventId") %>'">Edit</a>
                ...
                <ItemTemplate>
                   <asp:LinkButton ID="lbdel" runat="server" CssClass="body" 
                       CommandArgument='<%# Eval("EventId")+";"+ Eval("NewsImage")+ ";"+ Eval("pdf1")+";"+ Eval("pdf2")+";"+ Eval("pdf3")%>' OnClientClick="javascript:return confirmDelete();" Font-Underline="false" CommandName="deleterow" Text="Delete" OnClick="Button_Click">Delete</asp:LinkButton>
                   </ItemTemplate>
                   </asp:TemplateField> 
                    <asp:TemplateField AccessibleHeaderText="" HeaderText="View" ItemStyle-Width="75px" >
                   <ItemTemplate>                  

        <a target="_blank" href='<%# bindUrl( System.Convert.ToInt16(DataBinder.Eval(Container.DataItem, "EventId")),System.Convert.ToString(DataBinder.Eval(Container.DataItem, "Title"))) %>'>Live View</a>
        ...
        <div class="uk-grid uk-grid-small">
                                            <div class="uk-width-large-3-3">
                                                <asp:Button ID="btnAdd" runat="server" CssClass="md-btn md-btn-small md-btn-flat md-btn-success" Text=" Add Events " OnClick="btnAdd_Click" ValidationGroup="val" />
