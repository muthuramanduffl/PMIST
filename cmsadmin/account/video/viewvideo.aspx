<%@ Page Title="" Language="C#" MasterPageFile="../accountMaster.master" AutoEventWireup="true" CodeFile="viewvideo.aspx.cs" Inherits="admin_account_about_ViewNews" %>
...
<div class="uk-grid">
                    ...
                    <div class="uk-width-xLarge-1-1  uk-width-large-1-1">
                        <div class="md-card">
                            <div class="md-card-toolbar">
                                <h3 class="md-card-toolbar-heading-text">Dashboard / Video / <b>View Video List <asp:Label ID="lblDisplayText" runat="server"></asp:Label></b>
                                        ...
                                        <div class="uk-grid uk-grid-small">
                                            <div class="uk-width-large-3-3">
                                               ...
                                               <div class="table-responsive">
                                                <asp:GridView ID="grvContent" runat="server"  DataKeyNames="VideoId" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
              ...
              <Columns>   
                ...
                <ItemTemplate>
              <asp:Label ID="lblTitle" runat="server" Text='<%# Eval("VideoTitle")%>'></asp:Label>
                </ItemTemplate>
                
                 </asp:TemplateField>
               <%--  <asp:TemplateField AccessibleHeaderText="Name" HeaderText="Event Image" >
                <ItemTemplate>
                    <a id="A1" href='<%# bindImageTitle(System.Convert.ToString(DataBinder.Eval(Container.DataItem, "VdeoThumbImage")))%>' onclick='<%# BindPopup( System.Convert.ToString(DataBinder.Eval(Container.DataItem, "VdeoThumbImage"))) %>' runat="server"><%# bindImageTitle(System.Convert.ToString(DataBinder.Eval(Container.DataItem, "VdeoThumbImage")))%></a>
                </ItemTemplate>
                ...
                <ItemTemplate>
                   <asp:ImageButton ID="Archiveimg" ImageUrl='<%# bindImage( System.Convert.ToInt16(DataBinder.Eval(Container.DataItem, "Status"))) %>' CommandArgument='<%# Eval("VideoId") %>'  OnClick="Statusimg_click" runat="server"></asp:ImageButton>
                   </ItemTemplate>
                   </asp:TemplateField>  
        ...
        <a href='addvideo.aspx?ID=<%# Eval("VideoId") %>'">Edit</a>
                ...
                <ItemTemplate>
                   <asp:LinkButton ID="lbdel" runat="server" CssClass="body" 
                       CommandArgument='<%# Eval("VideoId")+";"+ Eval("VdeoThumbImage")%>' OnClientClick="javascript:return confirmDelete();" Font-Underline="false" CommandName="deleterow" Text="Delete" OnClick="Button_Click">Delete</asp:LinkButton>
                   </ItemTemplate>
                   </asp:TemplateField> 
        ...
        <div class="uk-grid uk-grid-small">
                                            <div class="uk-width-large-3-3">
                                                <asp:Button ID="btnAdd" runat="server" CssClass="md-btn md-btn-small md-btn-flat md-btn-success" Text=" Add Video " OnClick="btnAdd_Click" ValidationGroup="val" />
                                               <asp:Button ID="btnLiveView" runat="server" CssClass="md-btn md-btn-small md-btn-flat md-btn-success" Text="Live View" OnClick="btnLiveView_Click" OnClientClick="target ='_blank';"  />
                                            </div>
                                        </div>
