<%@ Page Title="" Language="C#" MasterPageFile="../accountMaster.master" AutoEventWireup="true" CodeFile="criteria.aspx.cs" Inherits="admin_account_naac_criteria" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageHeading" runat="Server">
    <h1><asp:Label ID="lblSchoolName" runat="server"></asp:Label> Criteria </h1>
</asp:Content>
...
onrowupdating="grvCriteria_RowUpdating"
        ...
        <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
              ...
              <Columns>   
                  <asp:TemplateField AccessibleHeaderText="Department" HeaderText="Criteria" >
                <ItemTemplate>
              <asp:Label ID="lblCriteria" runat="server" Text='<%# Eval("CriteriaNo")%>'></asp:Label>
                </ItemTemplate>
                 <EditItemTemplate>
              ...
              <asp:Label ID="lblTitle" runat="server" Text='<%# Eval("Title")%>'></asp:Label>
                 ...
                 <EditItemTemplate>
                   <asp:HiddenField ID="hiddenTitle" runat="server" Value='<%#Eval("Title") %>' />
                   <asp:HiddenField ID="hiddenStatus" runat="server" Value='<%#Eval("Active") %>' />
                  <asp:TextBox ID="txtEditTitle" MaxLength="150" Width="100px" runat="server" Text='<%#Eval("Title") %>'/>
