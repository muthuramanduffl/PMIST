<%@ Page Title="" Language="C#" MasterPageFile="../accountMaster.master" AutoEventWireup="true" CodeFile="Addnaac.aspx.cs" Inherits="admin_account_Slider_AddSlider" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageHeading" runat="Server">
    <h1>Naac <small>(Page Content)</small> </h1>
     <style>
    .remove {
  display: block;
  background: #444;
