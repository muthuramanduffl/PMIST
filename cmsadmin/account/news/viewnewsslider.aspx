<%@ Page Title="" Language="C#" MasterPageFile="../accountMaster.master" AutoEventWireup="true" CodeFile="viewnewsslider.aspx.cs" Inherits="admin_account_news_viewnewsslider" %>
...
<div class="uk-grid">
                    ...
                    <div class="uk-width-xLarge-1-1  uk-width-large-1-1">
                        <div class="md-card">
                            <div class="md-card-toolbar">
                                <h3 class="md-card-toolbar-heading-text">Dashboard / News / <b>View News List <asp:Label ID="lblDisplayText" runat="server"></asp:Label></b>
                                        ...
                                        <div class="uk-grid uk-grid-small">
                                            <div class="uk-width-large-3-3">
                                               ...
                                               <div class="table-responsive">
                                                <asp:GridView ID="grvContent" runat="server"  DataKeyNames="NewsId" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
              ...
              <asp:Label ID="lblTitle" runat="server" Text='<%# Eval("Title")%>'></asp:Label>
                   ...
                   <asp:TemplateField AccessibleHeaderText="Name" HeaderText="Url" >
                <ItemTemplate>
              <asp:Label ID="lblLinkUrl" runat="server" Text='<%# Eval("LinkUrl")%>'></asp:Label>
               ...
               <%--  <asp:TemplateField AccessibleHeaderText="Name" HeaderText="Event Image" >
                ...
                <ItemTemplate>
                   <asp:ImageButton ID="Archiveimg" ImageUrl='<%# bindImage( System.Convert.ToInt16(DataBinder.Eval(Container.DataItem, "Status"))) %>' CommandArgument='<%# Eval("NewsId") %>'  OnClick="Statusimg_click" runat="server"></asp:ImageButton>
                   </ItemTemplate>
                   </asp:TemplateField>  
        ...
        <a href='addnewsslider.aspx?ID=<%# Eval("NewsId") %>'">Edit</a>
                ...
                <ItemTemplate>
                   <asp:LinkButton ID="lbdel" runat="server" CssClass="body" 
                       CommandArgument='<%# Eval("NewsId")%>' OnClientClick="javascript:return confirmDelete();" Font-Underline="false" CommandName="deleterow" Text="Delete" OnClick="Button_Click">Delete</asp:LinkButton>
                   </ItemTemplate>
                   </asp:TemplateField> 
        ...
        <div class="uk-grid uk-grid-small">
                                            <div class="uk-width-large-3-3">
                                                <asp:Button ID="btnAdd" runat="server" CssClass="md-btn md-btn-small md-btn-flat md-btn-success" Text=" Add News " OnClick="btnAdd_Click" ValidationGroup="val" />
