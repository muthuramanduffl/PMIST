...
<h1>IQAC <small>(Page View)</small> </h1>
</asp:Content>
                    ...
                    <div class="uk-width-xLarge-1-1  uk-width-large-1-1">
                        <div class="md-card">
                            <div class="md-card-toolbar">
                                <h3 class="md-card-toolbar-heading-text">Dashboard - IQAC - <b>View</b>
                                </h3>
                            </div>
                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium">
                                    <div class="uk-width-large-2-3">
                                          Section:
                                                        ...
                                                        Sub Section:
                                                        <asp:DropDownList ID="ddlFilterMetric" runat="server" AutoPostBack="true" CssClass="select-list" Width="200px" OnSelectedIndexChanged="ddlFilterMetric_SelectedIndexChanged">
                                                         <asp:ListItem Value="All">All</asp:ListItem>  
                                                        </asp:DropDownList>
        ...
        <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
              ...
              <Columns> 
                ...
                <ItemTemplate>
                  ...
                  <asp:TemplateField AccessibleHeaderText="Metric" HeaderText="Sub Section">
                <ItemTemplate>
                   <asp:Label ID="lblSubSection" runat="server" Text='<%# Eval("SubSection")%>'></asp:Label>
                </ItemTemplate>
                ...
                <ItemTemplate>
                    <a id="A1" target="_blank" href='<%# bindImageHref(System.Convert.ToString(DataBinder.Eval(Container.DataItem, "Section")),System.Convert.ToString(DataBinder.Eval(Container.DataItem, "PdfUrl")))%>' runat="server">
                         <asp:Label ID="lblFile" runat="server" Text='<%# bindImageTitle(System.Convert.ToString(DataBinder.Eval(Container.DataItem, "PdfName")))%>' Width="70px"></asp:Label>
                       </a>
                </ItemTemplate>
                ...
                <ItemTemplate>
                    <asp:Label ID="lblDateTime" runat="server" Text='<%# bindDate( System.Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "AddedDate"))) %>' Width="70px"></asp:Label>
                </ItemTemplate>
                ...
                <ItemTemplate>
                   <a href='Add.aspx?ID=<%# Eval("Sno") %>'">Edit</a>
                   </ItemTemplate>
                   </asp:TemplateField>
                <asp:TemplateField AccessibleHeaderText="" HeaderText="Delete">
                <ItemTemplate>
                   <asp:LinkButton ID="lbdel" runat="server" CssClass="body" CommandArgument='<%# Eval("Sno") +"," + Eval("DisplayOrder")+"," + Eval("Section")+"," + Eval("SubSectionId") %>' OnClientClick="javascript:return confirmDelete();" Font-Underline="false" CommandName="deleterow" Text="Delete" OnClick="Button_Click">Delete</asp:LinkButton>
                   </ItemTemplate>
                   </asp:TemplateField> 
