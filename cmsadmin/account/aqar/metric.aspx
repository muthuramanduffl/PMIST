<%@ Page Title="" Language="C#" MasterPageFile="../accountMaster.master" AutoEventWireup="true" CodeFile="metric.aspx.cs" Inherits="admin_account_naac_criteria" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageHeading" runat="Server">
    <h1><asp:Label ID="lblSchoolName" runat="server"></asp:Label> Metric </h1>
</asp:Content>
        ...
        <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
              ...
              <asp:Label ID="lblCriteria" runat="server" Text='<%# Eval("CriteriaId")%>'></asp:Label>
                 ...
                 <EditItemTemplate>
                  ...
                  <asp:TemplateField AccessibleHeaderText="MetricNo" HeaderText="Metric No" >
                <ItemTemplate>
              <asp:Label ID="lblMetricNo" runat="server" Text='<%# Eval("MetricNo")%>'></asp:Label>
                </ItemTemplate>
                 <EditItemTemplate>
                   <asp:HiddenField ID="hiddenMetricNo" runat="server" Value='<%#Eval("MetricNo") %>' />
                  <asp:TextBox ID="txtEditMetricNo" MaxLength="150" Width="100px" runat="server" Text='<%#Eval("MetricNo") %>'/>
                    
                </EditItemTemplate>
                 </asp:TemplateField>
                   <asp:TemplateField AccessibleHeaderText="MetricName" HeaderText="Metric Name" >
                <ItemTemplate>
              <asp:Label ID="lblTitle" runat="server" style="word-wrap: break-word;" Text='<%# Eval("MetricName")%>'></asp:Label>
                </ItemTemplate>
                 <EditItemTemplate>
                   <asp:HiddenField ID="hiddenTitle" runat="server" Value='<%#Eval("MetricName") %>' />
                   <asp:HiddenField ID="hiddenStatus" runat="server" Value='<%#Eval("Active") %>' />
                  <asp:TextBox ID="txtEditTitle" MaxLength="150" Width="100px" runat="server" Text='<%#Eval("MetricName") %>'/>
                                        ...
                                        <div class="uk-grid uk-grid-small">
                                            <div class="uk-width-large-3-3">
                                                <div class="md-input-wrapper" id="dvCriteria" runat="server" style="padding-top:12px">
                                                    <asp:DropDownList ID="ddlCriteria" runat="server" CssClass="select-list">
                                        ...
                                        <div class="uk-grid uk-grid-small">
                                            <div class="uk-width-large-3-3">
                                                ...
                                                <div class="md-input-wrapper" id="dvMetricNo" runat="server" style="padding-top:19px">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please enter metric no" Display="None" ControlToValidate="txtMetricNo" ValidationGroup="val">
                                                     </asp:RequiredFieldValidator>
                                                     <asp:RegularExpressionValidator Id="RegularExpressionValidator2" Display="None" SetFocusOnError="true" RunAt="server" ValidationGroup="val" ControlToValidate="txtMetricNo" ErrorMessage="Please enter a valid metric no" ValidationExpression="^([0-9-.\s]*)$">
