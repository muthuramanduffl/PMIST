<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UCMenuHeader.ascx.cs" Inherits="includes_UCMenuHeader" %>
            ...
            <aside data-pushbar-id="left" data-pushbar-direction="left">
				...
				<a style="display:none" href="https://www.elkjournals.com/eng/hotmail-signup/" target="_blank" rel="dofollow">Hotmail</a>
                        ...
                        <div class="panel-accordion collapse" id="collapseProgram" aria-labelledby="headingOne"
                            ...
                            <div>
                                <button onclick="return false;"
                                    class="accordion1 respButton blueColor Oswald OswaldR" style="cursor: pointer;" > Faculty of Architecture and Planning</button>
                                <div class="panel">
				 ...
				 <a style="display:none" href="https://itiltd.in/eng/yahoo-mail-login/" title="yahoo mail"  rel="dofollow">Yahoo Mail</a>
                                ...
                                <button onclick="return false;"
                                    class="accordion1 respButton blueColor Oswald OswaldR" style="cursor: pointer;"  >Faculty of Computing Science and Applications
                                </button>
                                <div class="panel">
