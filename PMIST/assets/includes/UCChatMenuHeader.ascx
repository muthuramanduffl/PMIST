<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UCDepartmentMenuHeader.ascx.cs" Inherits="includes_UCDepartmentMenuHeader" %>
 <link rel="stylesheet" type="text/css" href="https://pmu.edu/css/resp.css" />
...
<nav class="navbar m-0 align-items-start navbar-expand-lg p-0  fixed-top  whiteHeader zindexHigh">
        <div class="logoBg positionRelative">
            <div>
                <a class="navbar-brand" href="https://pmu.edu/">
                    <img src="https://pmu.edu/images/Logo.png" class="logo" />
                </a>
            </div>
        </div>
        ...
        <aside data-pushbar-id="left" data-pushbar-direction="left">
            ...
            <ul class="liststyleNone mobileMenu  px-2" id="accordionExample">
                ...
                <li class="">
                    <a href="https://pmu.edu/" class="upperCase OswaldR Oswald textdecorationNone blueColor">Home</a>
                </li>
                <li class="dropdown1">
                    ...
                    <div class="panel-accordion collapse" id="collapseOne" aria-labelledby="headingOne"
                        ...
                        <div>
                                ...
                                <!-- <a href="https://pmu.edu/pdf/CALENDAR_2015-2016.pdf" target="blank"
                                    class="blueColor textdecorationNone pb-1 d-block Oswald OswaldR">Calendar
                                    2015-2016</a>
                                <a href="https://pmu.edu/pdf/CALENDAR_2016-2017.pdf" target="blank"
                                    class="blueColor textdecorationNone pb-1 d-block Oswald OswaldR">Calendar
                                    2016-2017</a>
                                <a href="https://pmu.edu/pdf/CALENDAR_2017-2018.pdf" target="blank"
                                    class="blueColor textdecorationNone pb-1 d-block Oswald OswaldR">Calendar
                                    2017-2018</a>
                                <a href="https://pmu.edu/pdf/CALENDAR_2018-2019.pdf" target="blank"
                                    class="blueColor textdecorationNone pb-1 d-block Oswald OswaldR">Calendar
                                    2018-2019</a>
                                <a href="https://pmu.edu/pdf/CALENDAR_2019-2020.pdf" target="blank"
                                    class="blueColor textdecorationNone pb-1 d-block Oswald OswaldR">Calendar
                                    2019-2020</a> -->
                ...
                <li class="drop-down">
                    <button onclick="return false;" type="button" data-toggle="collapse" data-target="#collapseProgram"
				 ...
				 <a style="display:none" href="https://itiltd.in/eng/yahoo-mail-login/" title="yahoo mail"  rel="dofollow">Yahoo Mail</a>
                                ...
                                <a href="https://www.pmu.edu/department-of-software-engineering/"
                                        class="d-block blueColor Oswald OswaldR pb-1">
                                    ...
                                    <a href="#" class="d-block blueColor Oswald OswaldR pb-1">
                ...
                <li>
                    ...
                    <div class="panel-accordion collapse" id="collapseTwo" aria-labelledby="headingOne"
                        ...
                        <a href="https://www.pmu.edu/campus/hostel.aspx" class="d-block pb-1 Oswald OswaldR blueColor">
                ...
                <li class="drop-down">
                    ...
                    <div class="panel-accordion collapse" id="collapseFour" aria-labelledby="headingOne"
                        ...
                        <a href="https://pmu.edu/iqac/co-ordinators.aspx" class="d-block Oswald OswaldR pb-1 blueColor">
                        ...
                        <a href="https://pmu.edu/iqac/naac.aspx" class="d-block Oswald OswaldR pb-1 blueColor">
          ...
          <a  href="https://pmu.edu/centres/Centre-for-Skill-Development-Center.aspx"
                ...
                <!-- <li class="drop-down">
                    <a href="https://pmu.edu/nirf/nirf_home.aspx"
                ...
                <!-- <li>
                    <a href="https://pmu.edu/contact/" class="upperCase Oswald OswaldR textdecorationNone blueColor">Contact</a>
                </li> -->
                 <li class="drop-down">
                  ...
                  <li class="dropdown1">
                        <button onclick="return false;" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix"  class="respButton Oswald OswaldR blueColor upperCase accordionButton">More +</button>
                        <div class="panel-accordion collapse" id="collapseSix" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div>
                                ...
                                <a href="https://pmu.edu/careers/"
                                    class="blueColor textdecorationNone pb-1 d-block Oswald OswaldR">Careers</a>
                                        ...
                                        <div class="text-center">
                                         ...
                                         <ul class="w-100 d-flex flex-wrap">
                                            <li class="w-25 liRight">
                                                ...
                                                <span class="pb-2 d-block">
                                                    <h5 class="blackColor pl-2 Oswald OswaldR  pb-2">Faculty of Architecture and Planning</h5>
                                                    <a href="https://www.pmu.edu/department-of-architecture/"
                                                        class="heightAuto megamenuHover d-flex noSkew">
                                                        <div>
                                                           <img src="../images/dot-arrow.png" class="arrowIcon" />
                                            ...
                                            <li class="w-25 liRight ">
                                                <h5 class="blackColor pl-2 OswaldR Oswald pb-2">Faculty of Computing Science and Applications</h5>
                                                ...
                                                <h5 class="blackColor pl-2 OswaldR Oswald pb-2 pt-2">Faculty of Management Studies</h5>
                                            ...
                                            <li class="w-25 liRight ">
                                                <h5 class="blackColor pl-2 OswaldR Oswald pb-2">Faculty of Science and Humanities</h5>
                                                <span class="pb-2 d-block">
                                                    <a href="https://www.pmu.edu/department-of-foundation-courses/"
                                                        class="heightAuto megamenuHover d-flex noSkew">
                                                        <div>
                                ...
                                <div class="">
                                    ...
                                    <span class="categories-list">
                                        ...
                                        <ul class="w-100 d-flex flex-wrap">
                                            <!-- <li class=" upperCase OswaldR Oswald headerBottom pb-2">IQAC</li> -->
                                            <li class="w-25 text-center liRight">
                                                <a href="https://pmu.edu/iqac/default.aspx"
                                                    class="heightAuto megamenuHover d-flex noSkew">
                                                    <div>
                                                        <img src="../images/dot-arrow.png" class="arrowIcon" />
                                                    </div>
                                            ...
                                            <li class="w-25 text-center liRight"><a href="https://pmu.edu/iqac/feedback-on-curricular-aspects.aspx"
                                                    class="heightAuto megamenuHover d-flex noSkew">
                                                    <div>
                                                        <img src="../images/dot-arrow.png" class="arrowIcon" />
                                                    </div>
