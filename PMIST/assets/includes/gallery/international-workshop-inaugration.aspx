<%@ Page Language="C#" AutoEventWireup="true" CodeFile="international-workshop-inaugration.aspx.cs" Inherits="gallery_international_workshop_inaugration" %>
  ...
  <div class="container">
    <div class="navi">
      <ul class="navi-link">
        ...
        <li><a href="/gallery/international-workshop-inaugration.aspx">International Workshop Inaugration</a></li>
      </ul>
    </div>
    <div class="content">
      <div class="gallery-1" style="width: 100%">
        <h2 class="fnt">International Workshop Inaugration - Bharathidasan University</h2>
        <div class="col-3">
