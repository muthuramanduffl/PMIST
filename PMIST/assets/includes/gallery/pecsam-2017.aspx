<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pecsam-2017.aspx.cs" Inherits="gallery_pecsam_2017" %>
  ...
  <div class="container">
    <div class="navi">
      <ul class="navi-link">
        ...
        <li><a href="/gallery/pecsam-2017.aspx">PECSAM - 2017</a></li>
      </ul>
    </div>
    <div class="content">
      <div class="gallery-1" style="width: 100%">
        <h2 class="fnt">PECSAM - 2017</h2>
        
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pecsam-2017/1.jpg" class="big"> <img src="images/pecsam-2017/1.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pecsam-2017/2.jpg" class="big"> <img src="images/pecsam-2017/2.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pecsam-2017/3.jpg" class="big"> <img src="images/pecsam-2017/3.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        ...
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pecsam-2017/4.jpg" class="big"> <img src="images/pecsam-2017/4.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        ...
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pecsam-2017/5.jpg" class="big"> <img src="images/pecsam-2017/5.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        ...
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pecsam-2017/6.jpg" class="big"> <img src="images/pecsam-2017/6.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        ...
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pecsam-2017/7.jpg" class="big"> <img src="images/pecsam-2017/7.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        ...
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pecsam-2017/8.jpg" class="big"> <img src="images/pecsam-2017/8.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        ...
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pecsam-2017/9.jpg" class="big"> <img src="images/pecsam-2017/9.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
