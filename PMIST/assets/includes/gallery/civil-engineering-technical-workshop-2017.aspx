<%@ Page Language="C#" AutoEventWireup="true" CodeFile="civil-engineering-technical-workshop-2017.aspx.cs" Inherits="gallery_civil_engineering_technical_workshop_2017" %>
  ...
  <div class="container">
    <div class="navi">
      <ul class="navi-link">
        ...
        <li><a href="javascript:void(0)">Civil Engineering Technical Work shop 2017</a></li>
      </ul>
    </div>
    <div class="content">
      <div class="gallery-1" style="width: 100%">
        <h2 class="fnt">Civil Engineering Technical Work shop 2017</h2>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/cetw/1.JPG" class="big"> <img src="images/cetw/1.JPG" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/cetw/2.JPG" class="big"> <img src="images/cetw/2.JPG" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/cetw/3.JPG" class="big"> <img src="images/cetw/3.JPG" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="clear"></div>
