<%@ Page Language="C#" AutoEventWireup="true" CodeFile="periyar-pinchu-pazhagu-mugaam-2017.aspx.cs" Inherits="gallery_periyar_pinchu_pazhagu_mugaam_2017" %>
  ...
  <div class="container">
    <div class="navi">
      <ul class="navi-link">
        ...
        <li><a href="javascript:void(0)">Periyar Pinchu Pazhagu Mugaam 2017</a></li>
      </ul>
    </div>
    <div class="content">
      <div class="gallery-1" style="width: 100%">
        <h2 class="fnt">Periyar Pinchu Pazhagu Mugaam 2017</h2>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pppm/img-06.jpg" class="big"> <img src="images/pppm/img-06.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pppm/img-07.jpg" class="big"> <img src="images/pppm/img-07.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pppm/img-08.jpg" class="big"> <img src="images/pppm/img-08.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pppm/img-10.jpg" class="big"> <img src="images/pppm/img-10.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pppm/img-11.jpg" class="big"> <img src="images/pppm/img-11.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pppm/img-12.jpg" class="big"> <img src="images/pppm/img-12.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pppm/img-13.jpg" class="big"> <img src="images/pppm/img-13.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pppm/img-14.jpg" class="big"> <img src="images/pppm/img-14.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pppm/img-15.jpg" class="big"> <img src="images/pppm/img-15.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pppm/img-16.jpg" class="big"> <img src="images/pppm/img-16.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/pppm/img-17.jpg" class="big"> <img src="images/pppm/img-17.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="clear"></div>
