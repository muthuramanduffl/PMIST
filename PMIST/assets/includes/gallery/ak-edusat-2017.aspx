<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ak-edusat-2017.aspx.cs" Inherits="gallery_ak_edusat_2017" %>
  ...
  <div class="container">
    <div class="navi">
      <ul class="navi-link">
        ...
        <li><a href="/gallery/ak-edusat-2017.aspx">Achievement in AK Edusat 2017</a></li>
      </ul>
    </div>
    <div class="content">
      <div class="gallery-1" style="width: 100%">
        <h2 class="fnt">Achievement in AK Edusat 2017</h2>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/AK/tho.jpg" class="big"> <img src="images/AK/tho.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/AK/theen.jpg" class="big"> <img src="images/AK/theen.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/AK/shar.jpg" class="big"> <img src="images/AK/shar.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="clear"></div>
