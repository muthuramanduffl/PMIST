<%@ Page Language="C#" AutoEventWireup="true" CodeFile="international-workshop-inauguration.aspx.cs" Inherits="gallery_international_workshop_inauguration" %>
  ...
  <div class="container">
    <div class="navi">
      <ul class="navi-link">
        ...
        <li><a href="/gallery/international-workshop-inauguration.aspx">International Workshop Inauguration</a></li>
      </ul>
    </div>
    <div class="content">
      <div class="gallery-1" style="width: 100%">
        <h2 class="fnt">International Workshop Inauguration - Bharathidasan University</h2>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/international-workshop/03.jpg" class="big"> <img src="images/international-workshop/03.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/international-workshop/02.jpg" class="big"> <img src="images/international-workshop/02.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/international-workshop/01.jpg" class="big"> <img src="images/international-workshop/01.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
