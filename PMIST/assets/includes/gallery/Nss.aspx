<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Nss.aspx.cs" Inherits="Nss" %>
      ...
      <div class="gallery-1" style="width: 100%">
        ...
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/NSS camp/01.jpg" class="big"> <img src="images/NSS camp/01.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
       ...
       <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/NSS camp/02.jpg" class="big"> <img src="images/NSS camp/02.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        ...
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/NSS camp/04.jpg" class="big"> <img src="images/NSS camp/04.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        ...
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/NSS camp/05.jpg" class="big"> <img src="images/NSS camp/05.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        ...
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/NSS camp/06.jpg" class="big"> <img src="images/NSS camp/06.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/NSS camp/07.jpg" class="big"> <img src="images/NSS camp/07.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/NSS camp/08.jpg" class="big"> <img src="images/NSS camp/08.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/NSS camp/09.jpg" class="big"> <img src="images/NSS camp/09.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
