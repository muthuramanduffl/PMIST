<%@ Page Language="C#" AutoEventWireup="true" CodeFile="inauguration-2017.aspx.cs" Inherits="gallery_inauguration_2017" %>
  ...
  <div class="container">
    <div class="navi">
      <ul class="navi-link">
        ...
        <li><a href="/gallery/inauguration-2017.aspx">Inauguration Programme for Computing Sciences and Engineering 2017</a></li>
      </ul>
    </div>
    <div class="content">
      <div class="gallery-1" style="width: 100%">
        <h2 class="fnt">Inauguration Programme for Computing Sciences and Engineering 2017</h2>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/Inauguration/1.jpg" class="big"> <img src="images/Inauguration/1.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/Inauguration/2.jpg" class="big"> <img src="images/Inauguration/2.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/Inauguration/3.jpg" class="big"> <img src="images/Inauguration/3.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/Inauguration/4.jpg" class="big"> <img src="images/Inauguration/4.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/Inauguration/5.jpg" class="big"> <img src="images/Inauguration/5.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/Inauguration/6.jpg" class="big"> <img src="images/Inauguration/6.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="clear"></div>
