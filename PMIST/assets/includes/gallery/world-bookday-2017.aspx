<%@ Page Language="C#" AutoEventWireup="true" CodeFile="world-bookday-2017.aspx.cs" Inherits="gallery_world_bookday_2017" %>
  ...
  <div class="container">
    <div class="navi">
      <ul class="navi-link">
        ...
        <li><a href="javascript:void(0)">World Book Day 2017</a></li>
      </ul>
    </div>
    <div class="content">
      <div class="gallery-1" style="width: 100%">
        <h2 class="fnt">World Book Days Photos</h2>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/wbdp/img-02.jpg" class="big"> <img src="images/wbdp/img-02.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/wbdp/img-03.jpg" class="big"> <img src="images/wbdp/img-03.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/wbdp/img-04.jpg" class="big"> <img src="images/wbdp/img-04.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/wbdp/img-05.jpg" class="big"> <img src="images/wbdp/img-05.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="clear"></div>
