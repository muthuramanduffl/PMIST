<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orientation-2017.aspx.cs" Inherits="gallery_orientation_2017" %>
  ...
  <div class="container">
    <div class="navi">
      <ul class="navi-link">
        ...
        <li><a href="/gallery/orientation-2017.aspx">Orientation Programme for school of engineering and technology 2017</a></li>
      </ul>
    </div>
    <div class="content">
      <div class="gallery-1" style="width: 100%">
        <h2 class="fnt">Orientation Programme for school of engineering and technology 2017</h2>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/orientation/1.jpg" class="big"> <img src="images/orientation/1.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/orientation/2.jpg" class="big"> <img src="images/orientation/2.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/orientation/3.jpg" class="big"> <img src="images/orientation/3.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/orientation/4.jpg" class="big"> <img src="images/orientation/4.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/orientation/5.jpg" class="big"> <img src="images/orientation/5.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="clear"></div>
