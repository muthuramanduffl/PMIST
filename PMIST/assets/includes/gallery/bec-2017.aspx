<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bec-2017.aspx.cs" Inherits="gallery_bec_2017" %>
  ...
  <div class="container">
    <div class="navi">
      <ul class="navi-link">
        ...
        <li><a href="/gallery/bec-2017.aspx">Faculty Development Programme on Business English Certificate</a></li>
      </ul>
    </div>
    <div class="content">
      <div class="gallery-1" style="width: 100%">
        <h2 class="fnt">Faculty Development Programme on Business English Certificate</h2>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/bec/1.jpg" class="big"> <img src="images/bec/1.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/bec/2.jpg" class="big"> <img src="images/bec/2.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="col-3">
          <div class="gallery-box-1 hover01 column gallery-2">
            <div>
              <figure> <a href="images/bec/3.jpg" class="big"> <img src="images/bec/3.jpg" alt="" /></a> </figure>
            </div>
          </div>
        </div>
        <div class="clear"></div>
