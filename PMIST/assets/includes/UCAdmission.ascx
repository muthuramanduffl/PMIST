<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UCAdmission.ascx.cs" Inherits="UCAdmission" %>
    <style>
        .customInputpopUp {
            height: auto;
        }
                        ...
                        <div class="pt-3">
                            <div class="modalBottom">
                                <div class="d-flex justify-content-between align-items-center pb-2">
                                    <h4 class="blueColor Oswald OswaldR upperCase semiBoldFont text-uppercase mb-0 admission-title-resp">Admission 2022 - Apply Now</h4>
                                ...
                                <div><p class="already-regi">Already Registered? <a href="https://pmu.edu/admission/Login.aspx">Click Here</a></p></div>
                            </div>
                            <div class="mt-4">
                                <div>
...
-->
                                ...
                                <div class="mt-2">
                                    ...
                                    <asp:DropDownList ID="ddlApplicationFor" runat="server" AutoPostBack="true"
                                                    ...
                                                    <asp:ListItem Value="B.Ed" Text="B.Ed"></asp:ListItem>
                                                   <%-- <asp:ListItem Value="B.Voc" Text="B.Voc"></asp:ListItem>--%>
                                                   <%-- <asp:ListItem Value="B.Des" Text="B.Des"></asp:ListItem>--%>
                                                    ...
                                                    <asp:ListItem Value="M.Sc" Text="M.Sc"></asp:ListItem>
                                                    <asp:ListItem Value="M.A" Text="M.A"></asp:ListItem>
                                                    <asp:ListItem Value="MBA" Text="MBA"></asp:ListItem>
                                                    <%--<asp:ListItem Value="M.Tech. (Integerated)" Text="M.Tech. (Integerated)"></asp:ListItem>--%>
                                                    <%--<asp:ListItem Value="M.S.C (Integerated)" Text="M.S.C (Integerated)"></asp:ListItem>--%>
                                                    <asp:ListItem Value="M.Com" Text="M.Com"></asp:ListItem>
                                                    <asp:ListItem Value="MSW" Text="MSW"></asp:ListItem>
                                                </asp:DropDownList>
