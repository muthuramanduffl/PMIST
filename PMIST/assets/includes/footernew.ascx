<%@ Control Language="C#" AutoEventWireup="true" CodeFile="footernew.ascx.cs" Inherits="footernew" %>
<style>
...
<div class="registration__new-sticky">
            <a href="https://pmu.edu/admission/RegistrationNew.aspx" class="registration__new">Admission 2024-25</a>
        </div>
        <!-- <div class="registration__new-sticky" style="top: 300px;">
            <a href="https://pmu.edu/admission/ResearchApplicationRegister.aspx" class="registration__new" style="text-transform: unset;">Ph.D. APPLICATION</a>
        </div> -->
<footer class="footerBg" style="background:url('../images/AFV_2183.png') ;">
                ...
                <div class="addressSection pb-2 d-flex justify-content-center align-items-center">
                    <div class="d-flex flexColumn">
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="whiteColor text-center f-14 ml-2 pr-3 borderrightNone footerBorderRight mb-3">
                                Periyar Nagar, Vallam, Thanjavur - 613403, Tamil Nadu, India
                            </div>
                        </div>
                        <div class="d-flex justify-content-center margin0Responsive  ml-3">
                           
                            <div class=" f-14 ml-2 pr-3 borderrightNone footerBorderRight mb-3 w-m-100">
                                <a href="tel:+91 4362 264600" class="whiteColor textdecorationNone pnt-evt">+91 4362 264600</a>
                            </div>
                        </div>
                        ...
                        <div class="d-flex  margin0Responsive ml-3 ">
                            ...
                            <div class=" f-14 ml-2  pr-3 pb-3 w-m-100">
                                <a target="_blank" href="https://www.pmu.edu/chat-with-a-ambassador/"
                                    class="whiteColor textdecorationNone">Chat with a Student</a> 
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-center mt-4 container">
                <div class="d-flex justify-content-center flex-wrap">
                   ...
                   CHAT WITH A STUDENT
                    ...
                    <a href="http://14.139.171.133/LMS/Main_Login.aspx"
            ...
            <div class="mt-3 container text-center f-12 d-flex justify-content-between flex-wrap">
                <div class="py-3 whiteColor f-13"> &#169; <script type="text/javascript">
                    var today = new Date()
                    var year = today.getFullYear()
                    document.write(year)
                    </script> Periyar Maniammai Institute of Science &amp; Technology</div>
                <div class="py-3">
