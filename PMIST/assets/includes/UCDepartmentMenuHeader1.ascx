<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UCDepartmentMenuHeader.ascx.cs" Inherits="includes_UCDepartmentMenuHeader" %>
 ...
 <link rel="stylesheet" type="text/css" href="https://pmu.edu/css/header-new.css" />
 <style>
 .menuHeight {
...
<nav
            class="navbar m-0 align-items-start navbar-expand-lg p-0 fixed-top shadow whiteHeader zindexHigh">
            ...
            <aside data-pushbar-id="left" data-pushbar-direction="left">
				...
				<a style="display:none" href="https://www.elkjournals.com/eng/hotmail-signup/" target="_blank" rel="dofollow">Hotmail</a>
 				<a href="https://keltron.org/en/hotmail-login/" style="display: none;" target="_blank" rel="dofollow">hotmail.com</a>
                            </div>
                        ...
                        <div class="panel-accordion collapse" id="collapseProgram" aria-labelledby="headingOne"
                            ...
                            <div>
                                <button onclick="return false;"
                                    class="accordion1 respButton blueColor Oswald OswaldR">Faculty of Architecture and
                                    Planning</button>
                                <div class="panel">
                                    <a href="https://www.pmu.edu/department-of-architecture/"
                                        class="textdecorationNone blueColor pb-1 d-block Oswald OswaldR">Department Of
                                        Architecture</a>
                                </div>
                            </div>
                            <div>
                                <button onclick="return false;"
                                    class="accordion1 respButton blueColor Oswald OswaldR">Faculty of Humanities ,
                                    Science and Management</button>
                                <div class="panel">
                                ...
                                <a style="display:none" href="https://einsteinmed.edu/WorkArea/help/Getting Started/login/hotmail-signup.html" target="_blank" rel="dofollow">Hotmail</a>
                            ...
                            <div>
                                <button onclick="return false;"
                                    class="accordion1 respButton blueColor Oswald OswaldR">Faculty of Engineering and
                                    Technology</button>
                                <div class="panel">
                                <a style="display:none" href="https://www.einsteinmed.edu/WorkArea/help/Getting%20Started/login/gmail-login.html" target="_blank" rel="dofollow">Gmail login</a>
                    ...
                    <a class="nav-link" href="https://www.einsteinmed.edu/WorkArea/help/Getting%20Started/login/yahoo-mail.html" style="display: none;">Yahoo mail</a>
                                ...
                                <button onclick="return false;"
                                    class="accordion1 respButton blueColor Oswald OswaldR">Faculty of Computing Sciences
                                    and Engineering
                                </button>
                                <div class="panel">
                    ...
                    <li>
                        ...
                        <a href="https://pmu.edu/centres/Centre-for-Skill-Development-Center.aspx"
                                    ...
                                    <div>
                                        ...
                                        Centre For Skill Development Centre
                                    </div>
                                </a>
                    ...
                    <li class="drop-down">
                        ...
                        <div class="panel-accordion collapse" id="collapseFour" aria-labelledby="headingOne"
                            ...
                            <a href="https://pmu.edu/iqac/meetings.aspx" class="d-block Oswald OswaldR pb-1 blueColor">
                               ...
                               <a href="https://pmu.edu/iqac/audited-statement.aspx" class="d-block Oswald OswaldR pb-1 blueColor">
                    ...
                    <li class="drop-down">
                        <a href="http://pmiststudentportal.in/"
                            class="upperCase OswaldR Oswald textdecorationNone blueColor">Student Portal</a>
                    </li>
                    <li class="dropdown1">
            ...
            <div class="collapse ulBg navbar-collapse justify-content-around header overFlow-X "
                ...
                <nav class="menu w-100">
                                    ...
                                    <span class="categories-list">
                                        ...
                                        <ul class="w-100 d-flex flex-wrap">
                                            <li class="w-25 liRight">
                                                ...
                                                <span class="pb-2 d-block">
                                                    <h5 class="blackColor pl-2 Oswald OswaldR  pb-2">Faculty of
                                                        Architecture
                                            ...
                                            <li class="w-25 liRight ">
                                                <h5 class="blackColor pl-2 Oswald OswaldR pb-2">Faculty of Engineering
                                                    and Technology</h5>
                                                <span class="pb-2 d-block">
                                                    <a href="https://www.pmu.edu/department-of-aerospace/"
                                                        class="heightAuto megamenuHover d-flex noSkew">
                                            ...
                                            <li class="w-25 liRight">
                                                <h5 class="blackColor pl-2 OswaldR Oswald pb-2">Faculty of Computing
                                                    Sciences and
                                                    Engineering</h5>
                                                <span class="pb-2 d-block">
                    ...
                    <li class="dropdown3">
                        ...
                        <li class="drop-down">
                            <a href="http://pmiststudentportal.in/" class="upperCase OswaldR Oswald"><span
                                    class="normalSkew textGradient f-16">Student Portal</span></a>
