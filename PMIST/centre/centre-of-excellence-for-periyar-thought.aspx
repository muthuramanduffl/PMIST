<%@ Page Language="C#" AutoEventWireup="true" CodeFile="centre-of-excellence-for-periyar-thought.aspx.cs" Inherits="PMIST_website_centre_centre_for_students_and_administrative_services" %>
                ...
                <div class="pt-5">
                    <div class="row m-0">
                        <div class="col-md-3 p-0 pb-md-0 pb-sm-5 pb-4">
                            <h1 class="page-heading btn-line position-relative">Centre Of Excellence For Periyar Thought
                            </h1>
                             <!-- sub menu list START -->
                     ...
                     <!-- sub menu list END -->
                        ...
                        <div class="col-md-9 p-0 ">
                            <div class="centre-content-side">
                                ...
                                <div class="pe-3 pe-sm-5 pb-sm-4 pb-4" style="display: none;">
