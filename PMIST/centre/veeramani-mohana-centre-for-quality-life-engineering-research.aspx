<%@ Page Language="C#" AutoEventWireup="true" CodeFile="veeramani-mohana-centre-for-quality-life-engineering-research.aspx.cs" Inherits="centre_vmcqler" %>
...
<head>
    ...
    <link href="../assets/css/centre/veeramani-mohana-centre-for-quality-of-life-engineering-research.css" rel="stylesheet">
                ...
                <div class="pt-5">
                    <div class="row m-0">
                        <div class="col-md-3 p-0 pb-md-0 pb-sm-5 pb-4">
                            <h1 class="page-heading btn-line position-relative">Veeramani Mohana Centre For Quality Of Life Engineering Research
                            </h1>
                            <!-- sub menu list START -->
                                ...
                                <div class="pe-3 pe-sm-5">
                                    <div class="contact py-5 position-relative">
                                        <div class=" contact-details">
                                            ...
                                            <h2 class="Research">Veeramani Mohana Centre for Quality Life Engineering Research (VMCQLER)</h2>
                                            <p class="role">Periyar Maniammai Institute of Science & Technology</p>
                                            <p class="role">Thanjavur</p>
                                            <p class="role text-decoration-underline">Email: dirvmc@pmu.edu</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
