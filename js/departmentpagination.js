...
function paginateit(content) {
    ...
    var show_per_page = 10; //change this to the amount you want to see for each set
    ...
    if (number_of_pages > max_pages_to_show) {
        ...
        while (i <= number_of_pages - 1) {
            ...
            if (i === 1 || i === number_of_pages - 1 || (i >= start_range && i <= end_range)) {
                if (i < page_num)
                    navigation_html += '<div class="page-item mx-1"><a class="page-link prevButton" href="javascript:go_to_page(' + i + ',\'' + content + '\')" longdesc="' + i + '">' + (i + 1) + '</a></div>';
                else
                    navigation_html += '<div class="page-item mx-1"><a class="page-link nextButton" href="javascript:go_to_page(' + i + ',\'' + content + '\')" longdesc="' + i + '">' + (i + 1) + '</a></div>';
            }
